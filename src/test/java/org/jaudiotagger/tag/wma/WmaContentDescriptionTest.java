...
public class WmaContentDescriptionTest extends WmaTestCase {
	...
	/**
	 * tests whether the content description chunk will disappear if not necessary.<br>
	 * 
	 * @throws Exception
	 *             On I/O Errors
	 */
	public void testContentDescriptionRemoval() throws Exception {
		...
		for (final String curr : ContentDescription.ALLOWED)
		...
		for (final String currKey : ContentDescription.ALLOWED) {
			final AsfFieldKey curr = AsfFieldKey.getAsfFieldKey(currKey);
