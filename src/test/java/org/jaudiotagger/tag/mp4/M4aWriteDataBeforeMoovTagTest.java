...
public class M4aWriteDataBeforeMoovTagTest extends TestCase {
	...
	public void testWriteFileOption1SameSize() {
		...
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test15.m4a", Paths.get("testWriteWhenMDatAtStart1.m4a"));
	...
	public void testWriteFileOption3SmallerSizeCreateFree() {
		Exception exceptionCaught = null;
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test15.m4a", Paths.get("testWriteWhenMDatAtStart2.m4a"));
	...
	public void testWriteFileOption4SmallerSizeNoFree() {
		Exception exceptionCaught = null;
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test15.m4a", Paths.get("testWriteWhenMDatAtStart3.m4a"));
	...
	public void testWriteFileOption8CannoutUseTopLevelFree() {
		Exception exceptionCaught = null;
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test15.m4a", Paths.get("testWriteWhenMDatAtStart8.m4a"));
			AudioFile f = AudioFileIO.read(testFile);
			Tag tag = f.getTag();
	...
	public void testWriteFileOption9CannoutUseTopLevelFree() {
		Exception exceptionCaught = null;
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test19.m4a", Paths.get("testWriteWhenMDatAtStart9.m4a"));
			AudioFile f = AudioFileIO.read(testFile);
			Tag tag = f.getTag();
