...
public class M4aReadDrmTagTest extends TestCase {
	/**
	 * Test to read all metadata from an Apple iTunes encoded mp4 file, note also uses fixed genre rather than custom
	 * genre
	 */
	public void testReadFile() {
		...
		try {
			...
			final Path testFile = AbstractTestCase.copyAudioToTmp("test9.m4p");
