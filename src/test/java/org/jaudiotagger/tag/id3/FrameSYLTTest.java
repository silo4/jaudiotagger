...
public class FrameSYLTTest extends AbstractTestCase {
	...
	public void testWriteFrame() throws Exception {
		...
		final ID3v24Tag id3 = new ID3v24Tag();
		...
		final FrameBodyTPE1 frameBody2 = new FrameBodyTPE1();
		frameBody2.setText("TESTINGFRAME");
		final ID3v24Frame frame2 = new ID3v24Frame(ID3v24Frames.FRAME_ID_ARTIST);
