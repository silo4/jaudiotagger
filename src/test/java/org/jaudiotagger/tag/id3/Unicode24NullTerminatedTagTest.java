...
public class Unicode24NullTerminatedTagTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public Unicode24NullTerminatedTagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testUTF8WithNullTerminator() throws IOException, TagException, ReadOnlyFileException, InvalidAudioFrameException, RuntimeException {
		final MP3File mp3File = new MP3File(AbstractTestCase.copyAudioToTmp("testV24-comments-utf8.mp3"));
		final AbstractID3v2Tag id3v2Tag = mp3File.getID3v2Tag();
		assertNotNull(id3v2Tag);
		final AbstractID3v2Frame frame = (AbstractID3v2Frame) id3v2Tag.getFrame("COMM");
		assertNotNull(frame);
		final AbstractTagFrameBody frameBody = frame.getBody();
		assertTrue(frameBody instanceof FrameBodyCOMM);
		final FrameBodyCOMM commFrameBody = (FrameBodyCOMM) frameBody;

		// String borodin = "\u0411\u043e\u0440\u043e\u0434\u0438\u043d";
		final byte UTF8_ENCODING = TextEncoding.UTF_8;
		final String language = "eng";
		final String comment = "some comment here";
		final String description = "cc";
		...
		final ID3v24Frame newFrame = new ID3v24Frame(ID3v24Frames.FRAME_ID_COMMENT);
		final FrameBodyCOMM targetFrameBody = (FrameBodyCOMM) newFrame.getBody();
	...
	public void testCreateISO8859EncodedNullTerminatedString() throws Exception {
		...
		final FrameBodyWXXX body = (FrameBodyWXXX) frame.getBody();
