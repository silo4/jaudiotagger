...
public class FrameBodyTRCKTest extends AbstractTestCase {
	...
	public static FrameBodyTRCK getInitialisedBody() {
		...
		final FrameBodyTRCK fb = new FrameBodyTRCK();
		fb.setTrackNo(1);
		fb.setTrackTotal(11);
		return fb;
	}
	...
	private void createFrameBodyAndAssertNumericValuesAndRawPaddingRetained(final String rawText, final int expectedCount, final int expectedTotal) {
		Exception exceptionCaught = null;
		FrameBodyTRCK fb = null;
		try {
