...
public class FrameBodyWXXXTest extends AbstractTestCase {
	...
	public static FrameBodyWXXX getInitialisedBody() {
		...
		final FrameBodyWXXX fb = new FrameBodyWXXX(TextEncoding.ISO_8859_1, WXXX_TEST_STRING, WXXX_TEST_URL);
		return fb;
	}

	public static FrameBodyWXXX getUnicodeRequiredInitialisedBody() {
		// Text Encoding doesnt matter until written to file
		final FrameBodyWXXX fb = new FrameBodyWXXX(TextEncoding.ISO_8859_1, WXXX_UNICODE_REQUIRED_TEST_STRING, WXXX_TEST_URL);
		return fb;
	}
