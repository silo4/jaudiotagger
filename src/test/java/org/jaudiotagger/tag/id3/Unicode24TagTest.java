...
public class Unicode24TagTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public Unicode24TagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testCreateISO8859EncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testISO8859.mp3"));
		...
		final FrameBodyTPE1 body = (FrameBodyTPE1) frame.getBody();
		assertEquals(ID3v24Frames.FRAME_ID_ARTIST, fb.getIdentifier());
		assertEquals(TextEncoding.ISO_8859_1, fb.getTextEncoding());
		assertEquals(FrameBodyTPE1Test.TPE1_TEST_STRING, fb.getText());
	}
	...
	public void testCreateUTF16BOMLEEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf16bomle.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF16BOMBEEncodedSizeTerminatedString() throws Exception {
		...
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf16bombe.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF16BOMLEAutoEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf16-2.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	/**
	 * Create a String that contains text outside of the IS8859 charset should be written as UTf8 because overridden
	 * default
	 * 
	 * @throws Exception
	 */
	public void testCreateUTF8AutoEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf8.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF16BEEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf16be.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF8EncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testutf8enc.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testv24TagsWithUTF8EncodingMaintainedOnSave() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("issue109-2.id3", "testV1.mp3");
