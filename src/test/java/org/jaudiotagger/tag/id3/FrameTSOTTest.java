...
public class FrameTSOTTest extends AbstractTestCase {
	public static ID3v24Frame getInitialisedFrame() {
		final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_TITLE_SORT_ORDER);
		final FrameBodyTSOT fb = FrameBodyTSOTTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}

	public static ID3v23Frame getV23InitialisedFrame() {
		final ID3v23Frame frame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_TITLE_SORT_ORDER_MUSICBRAINZ);
		final FrameBodyXSOT fb = FrameBodyXSOTTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public void testSaveToFile() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1010.mp3"));
		...
		final ID3v24Frame frame = (ID3v24Frame) mp3File.getID3v2Tag().getFrame(ID3v24Frames.FRAME_ID_TITLE_SORT_ORDER);
		final FrameBodyTSOT body = (FrameBodyTSOT) frame.getBody();
		assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
	}

	public void testSaveEmptyFrameToFile() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1011.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testConvertV24ToV23() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1012.mp3"));
		MP3File mp3File = new MP3File(testFile);
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v23Frame frame = (ID3v23Frame) mp3File.getID3v2Tag().getFrame(ID3v23Frames.FRAME_ID_V3_TITLE_SORT_ORDER_ITUNES);
		final FrameBodyTSOT body = (FrameBodyTSOT) frame.getBody();
		assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
	...
	public void testConvertV24ToV22() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1013.mp3"));
		MP3File mp3File = new MP3File(testFile);
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v22Frame frame = (ID3v22Frame) mp3File.getID3v2Tag().getFrame(ID3v22Frames.FRAME_ID_V2_TITLE_SORT_ORDER_ITUNES);
		final FrameBodyTSOT body = (FrameBodyTSOT) frame.getBody();
		assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
		assertEquals(FrameBodyTSOTTest.TITLE_SORT, body.getText());
	}
	...
	public void testConvertV23ITunesToV22() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1014.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testConvertV23MusicBrainzToV22() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("test1015.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testConvertV22ToV24() throws Exception {
		...
		final ID3v22Frame id3v22frame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_TITLE_SORT_ORDER_ITUNES);
