...
public class FrameTOPETest extends AbstractTestCase {
	public void testSavingV24ToV23() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue122.id3", "testV1.mp3");
		...
		final ID3v23Frame v23frame = (ID3v23Frame) v23Tag.getFrame(ID3v23Frames.FRAME_ID_V3_ORIGARTIST);
