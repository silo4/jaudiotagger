...
public class FramePCNTTest extends AbstractTestCase {
	public static ID3v24Frame getInitialisedFrame() {
		final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_PLAY_COUNTER);
		final FrameBodyPCNT fb = FrameBodyPCNTTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public void testSaveToFile() throws Exception {
		...
		final ID3v24Frame frame = (ID3v24Frame) mp3File.getID3v2Tag().getFrame(ID3v24Frames.FRAME_ID_PLAY_COUNTER);
		final FrameBodyPCNT body = (FrameBodyPCNT) frame.getBody();
