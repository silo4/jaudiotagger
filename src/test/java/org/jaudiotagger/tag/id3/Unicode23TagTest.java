...
public class Unicode23TagTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public Unicode23TagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testCreateUTF16BOMLEEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testv23utf16bomle.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF16BOMBEEncodedSizeTerminatedString() throws Exception {
		...
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testv23utf16bombe.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testCreateUTF16AutoEncodedSizeTerminatedString() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testv23utf16bomberequired.mp3"));
		MP3File mp3File = new MP3File(testFile);
	...
	public void testFixv23TagsWithInvalidEncoding() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue109.id3", "testV1.mp3");
	...
	public void testCreateUTF16BOMLEEvenIfNotNeededIfDefaultSetEncodedSizeTerminatedString() throws Exception {
		...
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testv23utf16bomleoption.mp3"));
		MP3File mp3File = new MP3File(testFile);
		...
		// Check Bytes
		final FileChannel fc = new RandomAccessFile(testFile.toFile(), "r").getChannel();
		final ByteBuffer buffer = ByteBuffer.allocate(100);
		final int count = fc.read(buffer);
		fc.close();
