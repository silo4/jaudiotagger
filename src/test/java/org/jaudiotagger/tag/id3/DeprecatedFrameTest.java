...
public class DeprecatedFrameTest extends AbstractTestCase {
	public void testv24TagWithDeprecatedFrameShouldCreateAsDeprecated() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue88.id3", "testV1.mp3");

		final MP3File mp3File = new MP3File(testFile);

		final ID3v24Frame v24frame = (ID3v24Frame) mp3File.getID3v2Tag().getFrame(ID3v23Frames.FRAME_ID_V3_TYER);
	...
	public void testSavingV24DeprecatedTIMETagToV23() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue122-1.id3", "testV1.mp3");
		MP3File mp3File = new MP3File(testFile);
		final ID3v24Tag v24Tag = (ID3v24Tag) mp3File.getID3v2Tag();
		final ID3v24Frame v24frame = (ID3v24Frame) v24Tag.getFrame(ID3v23Frames.FRAME_ID_V3_TIME);
		assertNotNull(v24frame);
		assertTrue(v24frame.getBody() instanceof FrameBodyDeprecated);
		...
		mp3File = new MP3File(testFile);
		v23Tag = (ID3v23Tag) mp3File.getID3v2Tag();
		final ID3v23Frame v23frame = (ID3v23Frame) v23Tag.getFrame(ID3v23Frames.FRAME_ID_V3_TIME);
		assertTrue(v23frame.getBody() instanceof FrameBodyTIME);
	}

	public void testSavingV24DeprecatedTDATTagToV23() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue122-2.id3", "testV1.mp3");
		MP3File mp3File = new MP3File(testFile);
		final ID3v24Tag v24Tag = (ID3v24Tag) mp3File.getID3v2Tag();
		final ID3v24Frame v24frame = (ID3v24Frame) v24Tag.getFrame(ID3v23Frames.FRAME_ID_V3_TDAT);
		assertNotNull(v24frame);
		assertTrue(v24frame.getBody() instanceof FrameBodyDeprecated);
		...
		mp3File = new MP3File(testFile);
		v23Tag = (ID3v23Tag) mp3File.getID3v2Tag();
		final Object v23frame = v23Tag.getFrame(ID3v23Frames.FRAME_ID_V3_TYER + ID3v23Frames.FRAME_ID_V3_TDAT);
