...
public class FrameTXXXTest extends AbstractTestCase {
	public static ID3v24Frame getV24InitialisedFrame() {
		final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO);
		final FrameBodyTXXX fb = FrameBodyTXXXTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public static ID3v22Frame getV22InitialisedFrame() {
		final ID3v22Frame frame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO);
		final FrameBodyTXXX fb = FrameBodyTXXXTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public void testSaveToFile() throws Exception {
		...
		final ID3v24Frame frame = (ID3v24Frame) mp3File.getID3v2Tag().getFrame(ID3v24Frames.FRAME_ID_USER_DEFINED_INFO);
		final FrameBodyTXXX body = (FrameBodyTXXX) frame.getBody();
	...
	public void testConvertV24ToV23() throws Exception {
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v23Frame frame = (ID3v23Frame) mp3File.getID3v2Tag().getFrame(ID3v23Frames.FRAME_ID_V3_USER_DEFINED_INFO);
		final FrameBodyTXXX body = (FrameBodyTXXX) frame.getBody();
		assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
	...
	public void testConvertV24ToV22() throws Exception {
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v22Frame frame = (ID3v22Frame) mp3File.getID3v2Tag().getFrame(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO);
		final FrameBodyTXXX body = (FrameBodyTXXX) frame.getBody();
		assertEquals(TextEncoding.ISO_8859_1, body.getTextEncoding());
		assertEquals(FrameBodyTXXXTest.TXXX_TEST_DESC, body.getText());
	}
	...
	public void testConvertV22ToV24() throws Exception {
		...
		final ID3v22Frame id3v22frame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_USER_DEFINED_INFO);
