 ...
 * prevent subsequent framesthat contain data from being read. Date: 01-Jan-2008
 */
public class EmptyFrameTest extends TestCase {
	public void testWriteID3v23TagWithEmptyFrameFirst() throws Exception {
		...
		final ID3v23Frame emptyFrame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_URL_FILE_WEB);
		((FrameBodyWOAF) emptyFrame.getBody()).setUrlLink("");
		final ID3v23Frame nonemptyFrame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_URL_OFFICIAL_RADIO);
	...
	public void testWriteID3v24TagWithEmptyFrameFirst() throws Exception {
		...
		final ID3v24Frame emptyFrame = new ID3v24Frame(ID3v24Frames.FRAME_ID_URL_FILE_WEB);
		((FrameBodyWOAF) emptyFrame.getBody()).setUrlLink("");
		final ID3v24Frame nonemptyFrame = new ID3v24Frame(ID3v24Frames.FRAME_ID_URL_OFFICIAL_RADIO);
		((FrameBodyWORS) nonemptyFrame.getBody()).setUrlLink("something");
	...
	public void testWriteID3v22TagWithEmptyFrameFirst() throws Exception {
		...
		final ID3v22Frame emptyFrame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_URL_FILE_WEB);
		((FrameBodyWOAF) emptyFrame.getBody()).setUrlLink("");
		final ID3v22Frame nonemptyFrame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_URL_OFFICIAL_RADIO);
		((FrameBodyWORS) nonemptyFrame.getBody()).setUrlLink("something");
