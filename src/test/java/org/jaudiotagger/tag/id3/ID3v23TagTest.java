...
public class ID3v23TagTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public ID3v23TagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testReadID3v1ID3v23Tag() {
		...
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1Cbr128ID3v1v2.mp3");
	...
	public void testReadID3v23Tag() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1Cbr128ID3v2.mp3");
	...
	public void testReadPaddedID3v23Tag() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1Cbr128ID3v2pad.mp3");
	...
	public void testCreateID3v23FromID3v11() {
		final ID3v11Tag v11Tag = ID3v11TagTest.getInitialisedTag();
		final ID3v23Tag v2Tag = new ID3v23Tag(v11Tag);
	...
	public void testCreateID3v23FromID3v24knownInV3() throws Exception {
		...
		final FrameBodyTIT2 framebodyTdrl = new FrameBodyTIT2();
		framebodyTdrl.setText("title");
		final ID3v24Frame tdrlFrame = new ID3v24Frame("TIT2");
	...
	public void testCreateID3v23FromID3v24UnknownInV3() throws Exception {
		...
		// Add v24 tag to mp3 with single tdrl frame (which is only supported in v24)
		final ID3v24Tag tag = new ID3v24Tag();
		final FrameBodyTDRL framebodyTdrl = new FrameBodyTDRL();
		framebodyTdrl.setText("2008");
		final ID3v24Frame tdrlFrame = new ID3v24Frame("TDRL");
		tdrlFrame.setBody(framebodyTdrl);
		tag.setFrame(tdrlFrame);
		mp3File.setID3v2Tag(tag);
		mp3File.save();
	 ...
	 */
	/*
	 * public void testCreateID3v23FromID3v24UnknownInV3AndV4()throws Exception { Path testFile =
	 * AbstractTestCase.copyAudioToTmp("testV1.mp3"); MP3File mp3File = null; mp3File = new MP3File(testFile);
	 * 
	 * //Add v24 tag to mp3 with single user defined frame byte[] byteData = new byte[1]; byteData[0] = 'X';
	 * 
	 * ID3v24Tag tag = new ID3v24Tag(); FrameBodyUnsupported framebodyUnsupported = new
	 * FrameBodyUnsupported("FREW",byteData); ID3v24Frame frame = new ID3v24Frame();
	 * frame.setBody(framebodyUnsupported); tag.setFrame(frame); mp3File.setID3v2Tag(tag); mp3File.save();
	 * 
	 * //Reread from File mp3File = new MP3File(testFile);
	 * 
	 * //Convert to v23 ,frame converted and marked as unsupported ID3v23Tag v23tag = new
	 * ID3v23Tag(mp3File.getID3v2TagAsv24()); ID3v23Frame v23frame = (ID3v23Frame)v23tag.getFrame("FREW");
	 * assertNotNull(v23frame); assertTrue(v23frame.getBody() instanceof FrameBodyUnsupported);
	 * 
	 * //Save as v23 tag (side effect convert v23 to v24 tag as well) mp3File.setID3v2Tag(v23tag); mp3File.save();
	 * 
	 * //Reread from File mp3File = new MP3File(testFile);
	 * 
	 * //Convert to v23 ,frame should still exist v23tag = (ID3v23Tag) mp3File.getID3v2Tag(); v23frame =
	 * (ID3v23Frame)v23tag.getFrame("FREW"); assertNotNull(v23frame); assertTrue(v23frame.getBody() instanceof
	 * FrameBodyUnsupported);
	 * 
	 * //Save as v23 tag (side effect convert v23 to v24 tag as well) mp3File.setID3v2Tag(v23tag); mp3File.save();
	 * 
	 * //Check value maintained, can only see as bytes FrameBodyUnsupported v23FrameBody =
	 * (FrameBodyUnsupported)v23frame.getBody();
