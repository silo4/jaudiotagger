...
public class ID3v22TagTest extends TestCase {
	 ...
	 * @param arg0
	 */
	public ID3v22TagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testCreateID3v22FromID3v11() {
		...
		final ID3v22Tag v2Tag = new ID3v22Tag(v11Tag);
	...
	public void testCreateIDv22TagAndSave() {
		...
		try {
			...
			final ID3v22Frame frame = (ID3v22Frame) v2Tag.getFrame(ID3v22Frames.FRAME_ID_V2_TITLE);
	...
	public void testv22TagWithUnneccessaryTrailingNulls() {
		final File orig = new File("testdata", "test24.mp3");
		if (!orig.isFile())
			return;

		Exception exception = null;
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test24.mp3");
			final AudioFile af = AudioFileIO.read(testFile);
			final MP3File m = (MP3File) af;
			...
			// Read using old Interface
			final ID3v22Tag v2Tag = (ID3v22Tag) m.getID3v2Tag();
