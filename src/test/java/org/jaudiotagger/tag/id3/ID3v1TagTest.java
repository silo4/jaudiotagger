...
public class ID3v1TagTest extends TestCase {
	...
	/**
	 * Provides an initialised object to be used in other tests to prevent code duplication
	 * 
	 * @return ID3v1Tag
	 */
	 ...
	 * @param arg0
	 */
	public ID3v1TagTest(final String arg0) {
		super(arg0);
	}
	...
	public void testCreateID3v1FromID3v24() {
		...
		final ID3v1Tag v1Tag = new ID3v1Tag(v2Tag);
		assertNotNull(v1Tag);
		assertEquals((byte) 1, v1Tag.getRelease());
		assertEquals((byte) 0, v1Tag.getMajorVersion());
		assertEquals((byte) 0, v1Tag.getRevision());
