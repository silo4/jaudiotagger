...
public class FramePICAndAPICTest extends AbstractTestCase {
	...
	public static ID3v24Frame getV24InitialisedFrame() {
		final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_ATTACHED_PICTURE);
		final FrameBodyAPIC fb = FrameBodyAPICTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}

	public static ID3v23Frame getV23InitialisedFrame() {
		final ID3v23Frame frame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_ATTACHED_PICTURE);
		final FrameBodyAPIC fb = FrameBodyAPICTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public static ID3v22Frame getV22InitialisedFrame() {
		final ID3v22Frame frame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_ATTACHED_PICTURE);
		final FrameBodyPIC fb = FrameBodyPICTest.getInitialisedBody();
		frame.setBody(fb);
		return frame;
	}
	...
	public void testSaveToFile() throws Exception {
		...
		final ID3v24Frame frame = (ID3v24Frame) mp3File.getID3v2Tag().getFrame(ID3v24Frames.FRAME_ID_ATTACHED_PICTURE);
	...
	public void testConvertV24ToV23() throws Exception {
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v23Frame frame = (ID3v23Frame) mp3File.getID3v2Tag().getFrame(ID3v23Frames.FRAME_ID_V3_ATTACHED_PICTURE);
		assertTrue(frame != null);
		final FrameBodyAPIC body = (FrameBodyAPIC) frame.getBody();
		assertTrue(body instanceof FrameBodyAPIC);
		assertEquals(FrameBodyAPICTest.DESCRIPTION, body.getDescription());
	...
	public void testConvertV24ToV22() throws Exception {
		...
		// Reload
		mp3File = new MP3File(testFile);
		final ID3v22Frame frame = (ID3v22Frame) mp3File.getID3v2Tag().getFrame(ID3v22Frames.FRAME_ID_V2_ATTACHED_PICTURE);
		assertTrue(frame != null);
