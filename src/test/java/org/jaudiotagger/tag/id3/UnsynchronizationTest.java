...
public class UnsynchronizationTest extends AbstractTestCase {
	...
	public void testv24TagCreateFrameUnsynced() throws Exception {
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue1.id3", "testV1.mp3");
	...
	public void testWriteLargeunsynchronizedFields() {
		...
		try {
			...
			testFile2 = AbstractTestCase.copyAudioToTmp("testV1.mp3", Paths.get("testV1-nonsynced.mp3"));
			...
			Artwork artworkUnsynced = ArtworkFactory.createArtworkFromFile(AbstractTestCase.dataPath.resolve("coverart_large.jpg"));
			...
			Artwork artworkNotsynced = ArtworkFactory.createArtworkFromFile(AbstractTestCase.dataPath.resolve("coverart_large.jpg"));
