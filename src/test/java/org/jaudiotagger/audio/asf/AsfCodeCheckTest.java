...
public class AsfCodeCheckTest extends TestCase {
	 ...
	 * For example if {@link AsfTag#createAlbumField(String)} returns a field whose
	 * {@link org.jaudiotagger.tag.TagField#getId()} equals {@link org.jaudiotagger.tag.asf.AsfFieldKey#ALBUM}s }.
	 */
