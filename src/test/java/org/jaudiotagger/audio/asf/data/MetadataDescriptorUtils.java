...
/**
 * This class provides methods for working with {@link MetadataDescriptor} objects.<br>
 * 
...
public final class MetadataDescriptorUtils {
	...
	/**
	 * This method tests, if both descriptors contain the same content and type, as well as if they belong to the same
	 ...
	 */
	public static boolean equals(final MetadataDescriptor m1, final MetadataDescriptor m2) {
		if (m1 == m2)
