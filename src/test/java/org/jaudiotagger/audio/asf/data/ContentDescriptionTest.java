...
public class ContentDescriptionTest extends AbstractMetadataContainer<ContentDescription> {
	 ...
	 */
	@Override
	protected ContentDescription createChunk(final long pos, final BigInteger size) {
	 ...
	 */
	@Override
	protected MetadataDescriptor[] createSupportedDescriptors(final ContentDescription container) {
		final List<MetadataDescriptor> result = new ArrayList<MetadataDescriptor>();
		MetadataDescriptor desc = new MetadataDescriptor(ContentDescription.KEY_AUTHOR);
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.ContentDescription#setAuthor(java.lang.String)} .
	 */
	public void testSetAuthor() {
		...
		try {
			chunk.setAuthor(AbstractChunk.createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			assertErrorMessage(ErrorMessage.WMA_LENGTH_OF_DATA_IS_TOO_LARGE, iae.getMessage());
		}
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.ContentDescription#setComment(java.lang.String)} .
	 */
	public void testSetComment() {
		...
		assertFalse(chunk.isEmpty());
		try {
			chunk.setComment(AbstractChunk.createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			assertErrorMessage(ErrorMessage.WMA_LENGTH_OF_DATA_IS_TOO_LARGE, iae.getMessage());
		}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.ContentDescription#setCopyright(java.lang.String)} .
	 */
	public void testSetCopyRight() {
		...
		assertFalse(chunk.isEmpty());
		try {
			chunk.setCopyright(AbstractChunk.createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			assertErrorMessage(ErrorMessage.WMA_LENGTH_OF_DATA_IS_TOO_LARGE, iae.getMessage());
		}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.ContentDescription#setRating(java.lang.String)} .
	 */
	public void testSetRating() {
		...
		assertFalse(chunk.isEmpty());
		try {
			chunk.setRating(AbstractChunk.createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			assertErrorMessage(ErrorMessage.WMA_LENGTH_OF_DATA_IS_TOO_LARGE, iae.getMessage());
		}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.ContentDescription#setTitle(java.lang.String)} .
	 */
	public void testSetTitle() {
		...
		assertFalse(chunk.isEmpty());
		try {
			chunk.setTitle(AbstractChunk.createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			assertErrorMessage(ErrorMessage.WMA_LENGTH_OF_DATA_IS_TOO_LARGE, iae.getMessage());
		}
