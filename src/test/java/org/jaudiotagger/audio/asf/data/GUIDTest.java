...
public class GUIDTest extends AbstractTestCase {
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.GUID#getConfigured(org.jaudiotagger.audio.asf.data.GUID)}
	 * .
	 */
	public void testGetConfigured() {
		for (final GUID curr : GUID.KNOWN_GUIDS) {
			// Loose all information except GUID raw data
			final GUID newOne = new GUID(curr.getBytes());
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.GUID#parseGUID(java.lang.String)}.
	 */
	public void testParseGUID() {
		for (final GUID curr : GUID.KNOWN_GUIDS)
			assertSame(curr, GUID.getConfigured(GUID.parseGUID(curr.toString())));
	...
	public void testToString() {
		assertEquals("f8699e40-5b4d-11cf-a8fd-00805f5c442b", GUID.GUID_AUDIOSTREAM.toString());
	}
