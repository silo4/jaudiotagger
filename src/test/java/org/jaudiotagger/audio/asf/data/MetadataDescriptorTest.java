...
public class MetadataDescriptorTest extends TestCase {
	 ...
	 */
	private final MetadataDescriptor descriptor1 = new MetadataDescriptor("testDescriptor");
	...
	/**
	 * This method calls {@link MetadataDescriptor#setString(String)} on given descriptor and expects an
	 ...
	 *            value to pass.
	 */
	protected void setStringFail(final MetadataDescriptor desc, final String value) {
		try {
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#createCopy()}.
	 */
	public void testCreateCopy() {
		final Random rand = new Random(System.currentTimeMillis());
		for (final ContainerType curr : ContainerType.getOrdered()) {
			final int stream = ContainerType.areInCorrectOrder(ContainerType.METADATA_OBJECT, curr) ? rand.nextInt(5) + 1 : 0;
			final int lang = ContainerType.areInCorrectOrder(ContainerType.METADATA_LIBRARY_OBJECT, curr) ? rand.nextInt(5) + 1 : 0;
			final MetadataDescriptor orig = new MetadataDescriptor(curr, "name", MetadataDescriptor.TYPE_STRING, stream, lang);
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#equals(java.lang.Object)} .
	 */
	public void testEqualsObject() {
		final ContainerType[] types = ContainerType.getOrdered();
		for (int i = 0; i < types.length; i++) {
			final MetadataDescriptor one = new MetadataDescriptor(types[i], types[i].name(), MetadataDescriptor.TYPE_STRING, types[i].isStreamNumberEnabled() ? 3 : 0, types[i].isLanguageEnabled() ? 3 : 0);
			one.setStringValue(createAString(i));
			assertFalse(one.equals(null));
			assertFalse(one.equals(new Object()));
			for (int j = 0; j < types.length; j++) {
				final MetadataDescriptor two = new MetadataDescriptor(types[j], types[j].name(), MetadataDescriptor.TYPE_STRING, types[j].isStreamNumberEnabled() ? 3 : 0, types[j].isLanguageEnabled() ? 3 : 0);
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getBoolean()}.
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getContainerType()} .
	 */
	public void testGetContainerType() {
		for (final ContainerType curr : ContainerType.values())
			assertSame(curr, new MetadataDescriptor(curr, "name", MetadataDescriptor.TYPE_STRING).getContainerType());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getLanguageIndex()} .
	 */
	public void testGetLanguageIndex() {
		assertSame(4, new MetadataDescriptor(ContainerType.METADATA_LIBRARY_OBJECT, "name", MetadataDescriptor.TYPE_STRING, 0, 4).getLanguageIndex());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getName()}.
	 */
	public void testGetName() {
		assertEquals("descriptorName", new MetadataDescriptor(ContainerType.METADATA_LIBRARY_OBJECT, "descriptorName", MetadataDescriptor.TYPE_STRING, 0, 4).getName());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getNumber()}.
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getRawDataSize()} .
	 */
	public void testGetRawDataSize() {
		this.descriptor1.setBinaryValue(new byte[20]);
		assertEquals(this.descriptor1.getRawData().length, this.descriptor1.getRawDataSize());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getStreamNumber()} .
	 */
	public void testGetStreamNumber() {
		this.descriptor1.setStreamNumber(55);
		assertEquals(55, this.descriptor1.getStreamNumber());
		assertEquals(55, new MetadataDescriptor(ContainerType.METADATA_OBJECT, "name", MetadataDescriptor.TYPE_STRING, 55, 0).getStreamNumber());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#getString()}.
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#isEmpty()}.
	 */
	public void testIsEmpty() {
		...
		assertFalse(this.descriptor1.isEmpty());
		this.descriptor1.setBinaryValue(new byte[0]);
		this.descriptor1.setGUIDValue(GUID.GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT);
		assertFalse(this.descriptor1.isEmpty());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setBinaryValue(byte[])} .
	 */
	public void testSetBinaryValue() {
		MetadataDescriptor desc = new MetadataDescriptor("name", MetadataDescriptor.TYPE_BOOLEAN);
		...
		desc = new MetadataDescriptor(ContainerType.EXTENDED_CONTENT, "name", MetadataDescriptor.TYPE_BINARY);
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setBooleanValue(boolean)} .
	 */
	public void testSetBooleanValue() {
		final MetadataDescriptor desc = new MetadataDescriptor("name", MetadataDescriptor.TYPE_BINARY);
		desc.setBooleanValue(true);
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setDWordValue(long)} .
	 */
	public void testSetDWordValue() {
		...
		for (final long curr : invalidValues)
			try {
	...
	public void testSetGUIDValue() {
		...
		for (final ContainerType curr : ContainerType.values())
			if (!curr.isGuidEnabled()) {
				try {
					new MetadataDescriptor(curr, "bla", MetadataDescriptor.TYPE_GUID);
					fail("Exception expected");
				} catch (final IllegalArgumentException e) {
					// expected
				}
				try {
					new MetadataDescriptor(curr, "bla", MetadataDescriptor.TYPE_STRING).setGUIDValue(GUID.GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT);
					fail("Exception expected");
				} catch (final IllegalArgumentException e) {
					// expected
				}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setLanguageIndex(int)} .
	 */
	public void testSetLanguageIndex() {
		final MetadataDescriptor desc = new MetadataDescriptor(ContainerType.METADATA_LIBRARY_OBJECT, "name", MetadataDescriptor.TYPE_BINARY, 0, 0);
		...
		for (final int curr : invalidValues)
			try {
		...
		try {
			new MetadataDescriptor(ContainerType.CONTENT_BRANDING, "name", MetadataDescriptor.TYPE_STRING, 0, 5);
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			// expected
		}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setQWordValue(java.math.BigInteger)} .
	 */
	public void testSetQWordValueBigInteger() {
		...
		final BigInteger[] invalidValues = { BigInteger.valueOf(-1l), qwordMax.add(BigInteger.ONE), null };
		for (final BigInteger curr : invalidValues)
			try {
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setQWordValue(long)} .
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setStreamNumber(int)} .
	 */
	public void testSetStreamNumber() {
		final MetadataDescriptor desc = new MetadataDescriptor(ContainerType.METADATA_OBJECT, "name", MetadataDescriptor.TYPE_BINARY, 0, 0);
		...
		try {
			new MetadataDescriptor(ContainerType.EXTENDED_CONTENT, "name", MetadataDescriptor.TYPE_STRING, 5, 0);
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			// expected
		}
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setString(java.lang.String)} .
	 */
	public void testSetString() {
		final MetadataDescriptor desc = new MetadataDescriptor(ContainerType.METADATA_LIBRARY_OBJECT, "name", MetadataDescriptor.TYPE_BOOLEAN);
		desc.setString("true");
		...
		setStringFail(desc, "nonumber");
		setStringFail(desc, MetadataDescriptor.QWORD_MAXVALUE.add(BigInteger.ONE).toString(10)); // too big.
		setStringFail(desc, String.valueOf(-1)); // too small
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setStringValue(java.lang.String)} .
	 */
	public void testSetStringValue() {
		MetadataDescriptor desc = new MetadataDescriptor(ContainerType.CONTENT_DESCRIPTION, "name", MetadataDescriptor.TYPE_STRING);
		...
		try {
			desc.setStringValue(createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
			fail("Exception expected");
		} catch (final IllegalArgumentException iae) {
			// expected
		}
		desc = new MetadataDescriptor(ContainerType.EXTENDED_CONTENT, "name", MetadataDescriptor.TYPE_STRING);
		...
		desc = new MetadataDescriptor(ContainerType.METADATA_LIBRARY_OBJECT, "name", MetadataDescriptor.TYPE_STRING);
		desc.setStringValue(createAString(MetadataDescriptor.WORD_MAXVALUE + 1));
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor#setWordValue(int)} .
	 */
