...
/**
 * This class provides methods for working with {@link MetadataContainer} objects.<br>
 * 
...
public final class MetadataContainerUtils {
	...
	// Logger Object
	public static Logger logger = Logger.getLogger("org.jaudiotagger.audio.asf");

	public static boolean equals(final List<MetadataDescriptor> l1, final List<MetadataDescriptor> l2) {
		...
		for (int i = 0; result && i < l1.size(); i++) {
			...
			if (!result)
				logger.warning("Unequal descriptors: " + l1.get(i) + " -> " + l2.get(i));
		}
		return result;
	}
	 ...
	 * {@link MetadataContainer#getPosition()} and {@link MetadataContainer#getChunkLength()} are ignored.
	 * 
	 * @param c1
	 *            container 1
	 * @param c2
	 ...
	 */
	public static boolean equals(final MetadataContainer c1, final MetadataContainer c2) {
		if (c1 == c2)
