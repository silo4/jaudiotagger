...
public class LanguageListTest extends AbstractChunk<LanguageList> {
	 ...
	 */
	@Override
	protected LanguageList createChunk(final long pos, final BigInteger size) {
		return new LanguageList(pos, size);
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.data.LanguageList#addLanguage(java.lang.String)} .
	 */
