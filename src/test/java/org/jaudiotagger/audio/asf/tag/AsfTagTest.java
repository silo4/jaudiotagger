...
public class AsfTagTest extends TestCase {
	...
	public void testIdentifierConversion() throws FieldDataInvalidException {
		...
		final TagField albumField = asfTag.createField(FieldKey.ALBUM, AsfFieldKey.ALBUM.getFieldName());
	...
	public void testMixedIdentifiers() throws Exception {
		final AsfTag asfTag = new AsfTag();
		final AsfTagTextField textField = asfTag.createField(AsfFieldKey.ALBUM, AsfFieldKey.ALBUM.toString());
	...
	public void testUncommonAsfTagFields() {
		...
		final List<TagField> copies = asfTag.getCopyright();
		final List<TagField> ratings = asfTag.getRating();
