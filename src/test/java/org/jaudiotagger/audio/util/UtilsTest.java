 ...
 * Except for methods related to {@link RandomAccessFile}, not worth the effort, since this ASF access is just about to
 * be replaced by streaming.
 * 
...
public class UtilsTest extends TestCase {
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#checkStringLengthNullSafe(java.lang.String)}
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#getBytes(long, int)}.
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#isBlank(java.lang.String)}.
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readBig64(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	public void testReadBig64InputStream() throws IOException {
		final BigInteger big64 = Utils.readBig64(new ByteArrayInputStream(MAX_LONG_64));
		assertEquals(Long.MAX_VALUE, big64.longValue());
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readCharacterSizedString(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             On I/O Errors.
	 */
	public void testReadCharacterSizedStringInputStream() throws IOException {
		...
		final String charSized = "This is a TestValue"; //$NON-NLS-1$
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readGUID(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Should not
	 */
	public void testReadGUIDInputStream() throws IOException {
		for (final GUID element : GUID.KNOWN_GUIDS) {
			final ByteArrayOutputStream bos = new ByteArrayOutputStream();
			bos.write(element.getBytes());
			final ByteArrayInputStream bis = new ByteArrayInputStream(bos.toByteArray());
			final GUID readGUID = Utils.readGUID(bis);
			assertTrue(readGUID.equals(element));
		}
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readUINT16(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	public void testReadUINT16InputStream() throws IOException {
		final long value = Utils.readUINT16(new ByteArrayInputStream(MAX_UINT16));
		assertEquals(Short.MAX_VALUE * 2 + 1, value);
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readUINT32(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	public void testReadUINT32InputStream() throws IOException {
		final long value = Utils.readUINT32(new ByteArrayInputStream(MAX_UINT32));
		assertEquals((long) Integer.MAX_VALUE * 2 + 1, value);
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readUINT64(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	public void testReadUINT64InputStream() throws IOException {
		final long value = Utils.readUINT64(new ByteArrayInputStream(MAX_LONG_64));
		assertEquals(Long.MAX_VALUE, value);
	}

	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#readUTF16LEStr(java.io.InputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	public void testReadUTF16LEStrInputStream() throws IOException {
		final ByteArrayOutputStream bos = new ByteArrayOutputStream();
		final String testValue = "Testvalue"; //$NON-NLS-1$
		// Test with zero term
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#writeUINT16(int, java.io.OutputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#writeUINT32(long, java.io.OutputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
	...
	/**
	 * Test method for {@link org.jaudiotagger.audio.asf.util.Utils#writeUINT64(long, java.io.OutputStream)} .
	 * 
	 * @throws IOException
	 *             Never
	 */
