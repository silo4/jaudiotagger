...
public class MP3AudioHeaderTest extends TestCase {
	...
	public void testReadV1L3Cbr128() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1Cbr128.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV1L3Cbr192() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1Cbr192.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV2L3VbrOld() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV2vbrOld0.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV2L3MonoVbrNew() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV2vbrNew0.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV1L2Stereo() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1L2stereo.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV1L2Mono() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV1L2mono.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV25L3VbrOld() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV25vbrOld0.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV25L3VbrNew() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV25vbrNew0.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV2L2() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV2L2.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testReadV2L3Stereo() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("testV2L3Stereo.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testIssue79() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue79.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	public void testIssue81() {
		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("Issue81.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
	...
	/**
	 * Test mp3s display tracks over an hour correctly, dont actually have any such track so have to emulate the mp3
	...
	/**
	 * Test trying to parse an mp3 file with a ID3 tag header reporting to short causing jaudiotagger to end up reading
	 * mp3 header from too early causing audio header to be read incorrectly
	 */
	public void testIssue110() {
		final File orig = new File("testdata", "test28.mp3");
		if (!orig.isFile())
			return;

		Exception exceptionCaught = null;
		final Path testFile = AbstractTestCase.copyAudioToTmp("test28.mp3");
		MP3AudioHeader mp3AudioHeader = null;
		try {
			mp3AudioHeader = new MP3File(testFile).getMP3AudioHeader();
