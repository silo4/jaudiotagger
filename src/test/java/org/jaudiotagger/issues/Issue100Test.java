...
public class Issue100Test extends AbstractTestCase {
	public void testID3v24WriteFieldsInPreferredOrder() {
		...
		try {
			...
			{
				final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_PRIVATE);
				tag.setFrame(frame);
			}
			{
				final ID3v24Frame frame = new ID3v24Frame(ID3v24Frames.FRAME_ID_UNIQUE_FILE_ID);
				tag.setFrame(frame);
			}
	...
	public void testID3v23WriteFieldsInPreferredOrder() {
		...
		try {
			...
			{
				final ID3v23Frame frame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_PRIVATE);
				tag.setFrame(frame);
			}
			{
				final ID3v23Frame frame = new ID3v23Frame(ID3v23Frames.FRAME_ID_V3_UNIQUE_FILE_ID);
				tag.setFrame(frame);
			}
			AudioFile af = AudioFileIO.read(testFile);
			MP3File mp3File = (MP3File) af;
	...
	public void testID3v22WriteFieldsInPreferredOrder() {
		...
		try {
			...
			{
				final ID3v22Frame frame = new ID3v22Frame(ID3v22Frames.FRAME_ID_V2_UNIQUE_FILE_ID);
				tag.setFrame(frame);
			}
			AudioFile af = AudioFileIO.read(testFile);
			MP3File mp3File = (MP3File) af;
