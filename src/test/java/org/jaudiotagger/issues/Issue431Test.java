...
public class Issue431Test extends AbstractTestCase {
	public void testSetTrackNo() throws Exception {
		...
		final ID3v23Frame frame = (ID3v23Frame) ((ID3v23Tag) tag).getFrame("TRCK");
		final ID3v23FrameBody frameBody = (ID3v23FrameBody) frame.getBody();
		final FrameBodyTRCK frameBodyTrck = (FrameBodyTRCK) frameBody;
	...
	public void testSetDiscNo() throws Exception {
		...
		// Check the underlying frame
		final ID3v23Frame frame = (ID3v23Frame) ((ID3v23Tag) tag).getFrame("TPOS");
		final ID3v23FrameBody frameBody = (ID3v23FrameBody) frame.getBody();
		final FrameBodyTPOS frameBodyTpos = (FrameBodyTPOS) frameBody;
