...
public class Issue298Test extends AbstractTestCase {
	...
	public void testWriteFieldsToMp3ID3v24() {
		...
		try {
			...
			{
				final TagField tagField = af.getTag().getFirstField(FieldKey.CUSTOM1);
			...
			assertEquals("Bad Mood", af.getTag().getFirst(FieldKey.MOOD));
			{
				...
				assertTrue(tagField instanceof ID3v24Frame);
				assertTrue(((ID3v24Frame) tagField).getBody() instanceof FrameBodyCOMM);
				final FrameBodyCOMM body = (FrameBodyCOMM) ((ID3v24Frame) tagField).getBody();
				assertEquals(FrameBodyCOMM.MM_CUSTOM1, body.getDescription());
				assertEquals(Languages.MEDIA_MONKEY_ID, body.getLanguage());
			}
			{
				final TagField tagField = af.getTag().getFirstField(FieldKey.CUSTOM2);
				assertTrue(tagField instanceof ID3v24Frame);
				assertTrue(((ID3v24Frame) tagField).getBody() instanceof FrameBodyCOMM);
				final FrameBodyCOMM body = (FrameBodyCOMM) ((ID3v24Frame) tagField).getBody();
			...
			{
				final TagField tagField = af.getTag().getFirstField(FieldKey.CUSTOM3);
				assertTrue(tagField instanceof ID3v24Frame);
				assertTrue(((ID3v24Frame) tagField).getBody() instanceof FrameBodyCOMM);
				final FrameBodyCOMM body = (FrameBodyCOMM) ((ID3v24Frame) tagField).getBody();
			...
			{
				final TagField tagField = af.getTag().getFirstField(FieldKey.CUSTOM4);
				assertTrue(tagField instanceof ID3v24Frame);
				assertTrue(((ID3v24Frame) tagField).getBody() instanceof FrameBodyCOMM);
				final FrameBodyCOMM body = (FrameBodyCOMM) ((ID3v24Frame) tagField).getBody();
			...
			{
				final TagField tagField = af.getTag().getFirstField(FieldKey.CUSTOM5);
				assertTrue(tagField instanceof ID3v24Frame);
				assertTrue(((ID3v24Frame) tagField).getBody() instanceof FrameBodyCOMM);
				final FrameBodyCOMM body = (FrameBodyCOMM) ((ID3v24Frame) tagField).getBody();
