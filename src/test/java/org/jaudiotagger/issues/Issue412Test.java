...
public class Issue412Test extends AbstractTestCase {
	...
	public void testDiscNoTotalAddCombinations() {
		...
		try {
			...
			af = AudioFileIO.read(testFile);
			tag = af.getTag();
			final ID3v23Tag v23tag = (ID3v23Tag) tag;
			final AbstractID3v2Frame frame = (AbstractID3v2Frame) v23tag.getFrame("TPOS");
			final FrameBodyTPOS fbBody = (FrameBodyTPOS) frame.getBody();
