...
public class Issue269Test extends AbstractTestCase {
	...
	public void testReadMp3WithEncryptedField() {
		...
		try {
			...
			final AbstractID3v2Frame frame1 = (AbstractID3v2Frame) id3v23Tag.getFrame(ID3v23Frames.FRAME_ID_V3_COPYRIGHTINFO);
			assertNotNull(frame1);
			assertEquals("", ((FrameBodyTCOP) frame1.getBody()).getText());

			// This frame is marked as encrypted(Although it actually isn't) so we cant decode it we should just store
			// it
