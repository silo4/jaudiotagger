...
public class Issue307Test extends AbstractTestCase {
	...
	public void testMultiThreadedMP3HeaderAccess() throws Exception {
		final Path orig = AbstractTestCase.dataPath.resolve("test71.mp3");
		...
		try {
			final Path testFile = AbstractTestCase.copyAudioToTmp("test71.mp3");
		...
		assertNull(e);
		final FrameBodyIPLS frameBody = (FrameBodyIPLS) (((ID3v23Frame) ((ID3v23Tag) mp3File.getTag()).getFirstField("IPLS")).getBody());
