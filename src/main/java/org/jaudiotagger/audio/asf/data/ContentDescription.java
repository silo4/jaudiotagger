...
/**
 * This class represents the data of a chunk which contains title, author, copyright, description and the rating of the
 * file. <br>
...
public final class ContentDescription extends MetadataContainer {
	 ...
	 *             If "UTF-16LE"-byte-representation would take more than 65535 bytes.
	 */
