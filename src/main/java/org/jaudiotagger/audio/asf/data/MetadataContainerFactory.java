...
/**
 * A factory for creating appropriate {@link MetadataContainer} objects upon specified {@linkplain ContainerType
 * container types}.<br>
 * 
...
public final class MetadataContainerFactory {
	...
	/**
	 * Convenience Method for I/O. Same as {@link #createContainer(ContainerType)}, but additionally assigns position
	 * and size. (since a {@link MetadataContainer} is actually a {@link Chunk}).
	 * 
	 * @param type
	 *            The containers type.
	 * @param pos
	 ...
	 * @return an appropriate container implementation with assigned size and position.
	 */
