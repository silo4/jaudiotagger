...
public class StreamBitratePropertiesChunk extends Chunk {
	...
	/**
	 * For each call of {@link #addBitrateRecord(int,long)} an {@link Long} object is appended, which represents the
	 * average bitrate.
	 */
	private final List<Long> bitRates;

	/**
	 * For each call of {@link #addBitrateRecord(int,long)} an {@link Integer} object is appended, which represents the
	 * stream-number.
	 */
