...
public final class AudioStreamChunk extends StreamChunk {
	 ...
	 */
	public final static String[][] CODEC_DESCRIPTIONS = { { "161", " (Windows Media Audio (ver 7,8,9))" }, { "162", " (Windows Media Audio 9 series (Professional))" }, { "163", "(Windows Media Audio 9 series (Lossless))" },
	...
	/**
	 * This method will take a look at {@link #compressionFormat}and returns a String with its hex value and if known a
	 * textual note on what coded it represents. <br>
	 * 
	...
	/**
	 * This method takes the value of {@link #getAverageBytesPerSec()}and calculates the kbps out of it, by simply
	 * multiplying by 8 and dividing by 1000. <br>
	 * 
