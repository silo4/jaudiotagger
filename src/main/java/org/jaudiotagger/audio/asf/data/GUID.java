...
/**
 * This class is used for representation of GUIDs and as a reference list of all Known GUIDs. <br>
 * 
...
public final class GUID {
	...
	/**
	 * This constant defines the GUID for stream chunks describing audio streams, indicating the the audio stream has no
	...
	/**
	 * This constant defines the GUID for stream chunks describing audio streams, indicating the the audio stream has
	 * interleaved error concealment. <br>
	 */
	...
	/**
	 * This constant represents the guidData for a chunk which contains Title, author, copyright, description and
	 * rating.
	 */
	...
	/**
	 * This constant defines the GUID for a WMA "Extended Content Description" chunk. <br>
	 */
	...
	/**
	 * This map is used, to get the description of a GUID instance, which has been created by reading.<br>
	 * The map comparison is done against the {@link GUID#guidData} field. But only the {@link #KNOWN_GUIDS} have a
	 * description set.
	 */
	private final static Map<GUID, GUID> GUID_TO_CONFIGURED;

	/**
	 * This constant represents a GUID implementation which can be used for generic implementations, which have to
	 * provide a GUID, but do not really require a specific GUID to work.
	 */
	...
	static {
		KNOWN_GUIDS = new GUID[] { GUID_AUDIO_ERROR_CONCEALEMENT_ABSENT, GUID_CONTENTDESCRIPTION, GUID_AUDIOSTREAM, GUID_ENCODING, GUID_FILE, GUID_HEADER, GUID_STREAM, GUID_EXTENDED_CONTENT_DESCRIPTION, GUID_VIDEOSTREAM,
				GUID_HEADER_EXTENSION, GUID_STREAM_BITRATE_PROPERTIES, SCRIPT_COMMAND_OBJECT, GUID_CONTENT_ENCRYPTION, GUID_CONTENT_BRANDING, GUID_UNSPECIFIED, GUID_METADATA_LIBRARY, GUID_METADATA, GUID_LANGUAGE_LIST };
	...
	/**
	 * This method checks if the given <code>value</code> is matching the GUID specification of ASF streams. <br>
	 * 
	 * @param value
	 *            possible GUID.
	...
	/**
	 * This method searches a GUID in {@link #KNOWN_GUIDS}which is equal to the given <code>guidData</code> and returns
	 * its description. <br>
	...
	/**
	 * An instance of this class stores the value of the wrapped GUID in this field. <br>
	 */
	...
	/**
	 * Creates an instance like {@link #GUID(int[])} and sets the optional description. (the int[] is obtained by
	 * {@link GUID#parseGUID(String)}) <br>
	 * 
	 * @param guidString
	 *            GUID, which should be assigned.
	 * @param desc
	...
	/**
	 * This method compares two objects. If the given Object is a {@link GUID}, the stored GUID values are compared. <br>
	 * 
	...
	/**
	 * This method checks if the currently stored GUID ({@link #guidData}) is correctly filled. <br>
	 * 
	...
	/**
	 * This method saves a copy of the given <code>value</code> as the represented value of this object. <br>
