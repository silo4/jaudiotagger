 ...
 * The language list is simply a listing of language codes which should comply to RFC-1766.<br>
 * <b>Consider:</b> the index of a language is used by other entries in the ASF metadata.
 * 
