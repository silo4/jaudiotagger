...
/**
 * This class was intended to store the data of a chunk which contained the encoding parameters in textual form. <br>
 * Since the needed parameters were found in other chunks the implementation of this class was paused. <br>
...
public class EncodingChunk extends Chunk {
	...
	/**
	 * This method returns a collection of all {@linkplain String Strings} which were added due
	 * {@link #addString(String)}.
	 * 
