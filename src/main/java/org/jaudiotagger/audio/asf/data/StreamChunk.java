 ...
 * A Stream chunk delivers information about a audio or video stream. Because of this the stream chunk identifies in one
 * field what type of stream it is describing and so other data is provided. However some information is common to all
 * stream chunks which are stored in this hierarchy of the class tree.
 * 
...
public abstract class StreamChunk extends Chunk {
	 ...
	 * 
	 * @param streamType
	 *            The GUID which tells the stream type represented ( {@link GUID#GUID_AUDIOSTREAM} or
	 *            {@link GUID#GUID_VIDEOSTREAM} ):
	 * @param chunkLen
	 *            length of chunk
	 */
