...
/**
 * This structure represents the value of the content branding object, which stores the banner image, the banner image
 * URL and the copyright URL.<br>
 * 
...
public final class ContentBranding extends MetadataContainer {
	...
	/**
	 * This method sets the banner image URL, if <code>imageURL</code> is not blank.<br>
	 * 
	 * @param imageURL
	 *            image URL to set.
	 */
	...
	/**
	 * This method sets the copyright URL, if <code>copyRight</code> is not blank.<br>
	 * 
	 * @param copyRight
