...
/**
 * This structure represents the &quot;Metadata Object&quot;,&quot;Metadata Library Object&quot; and &quot;Extended
...
public class MetadataContainer extends Chunk implements WriteableChunk {
	...
	/**
	 * This class is used to uniquely identify an enclosed descriptor by its name, language index and stream number.<br>
	...
	/**
	 * for performance reasons this instance is used to look up existing descriptors in {@link #descriptors}.<br>
	 */
	 ...
	 * @throws IllegalArgumentException
	 *             if descriptor does not meet container requirements, or already exist.
	 */
	...
	/**
	 * This method asserts that this container has a descriptor with the specified key, means returns an existing or
	 * creates a new descriptor.
	 * 
	 * @param key
	 *            the descriptor name to look up (or create)
	 * @return the/a descriptor with the specified name (and initial type of {@link MetadataDescriptor#TYPE_STRING}.
	 */
	...
	/**
	 * Returns a list of descriptors with the given {@linkplain MetadataDescriptor#getName() name}.<br>
	 * 
	 * @param name
	...
	/**
	 * This method looks up a descriptor with given name and returns its value as string.<br>
	 * 
	 * @param name
	 *            the name of the descriptor to look up.
	 * @return the string representation of a found descriptors value. Even an empty string if no descriptor has been
	 *         found.
	 */
	...
	/**
	 * Determines if this container contains a descriptor with given {@linkplain MetadataDescriptor#getName() name}.<br>
	 * 
	 * @param name
	 ...
	 * This implies a check for the capabilities of the container specified by its {@linkplain #getContainerType()
	 * container type}.<br>
	 * 
	 * @param descriptor
	 *            the descriptor to test.
	 * @return <code>true</code> if {@link #addDescriptor(MetadataDescriptor)} can be called with given descriptor.
	 */
	...
	/**
	 * Removes all stored descriptors with the given {@linkplain MetadataDescriptor#getName() name}.<br>
	 * 
	 * @param name
	 *            the name to remove.
	 */
	...
	/**
	 * {@linkplain #assertDescriptor(String) asserts} the existence of a descriptor with given <code>name</code> and
	 * {@linkplain MetadataDescriptor#setStringValue(String) assings} the string value.
	 * 
	 * @param name
