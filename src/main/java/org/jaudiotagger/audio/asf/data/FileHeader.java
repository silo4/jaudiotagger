...
/**
 * This class stores the information about the file, which is contained within a special chunk of ASF files.<br>
 * 
...
public class FileHeader extends Chunk {
	 ...
	 * <b>Warning: </b> must be same size as {@link #minPackageSize}. Its not known how to handle deviating values.
	 */
	private final long maxPackageSize;

	/**
	 * Minimun size of stream packages. <br>
	 * <b>Warning: </b> must be same size as {@link #maxPackageSize}. Its not known how to handle deviating values.
	 */
	 ...
	 * @param fileTime
	 *            Time file or stream was created. Time is calculated since 1st january of 1601 in 100ns steps.
	 * @param pkgCount
	 ...
	 *            Size of an uncompressed Video Frame.
	 */
	public FileHeader(final BigInteger chunckLen, final BigInteger size, final BigInteger fileTime, final BigInteger pkgCount, final BigInteger dur, final BigInteger timestampStart, final BigInteger timestampEnd, final long headerFlags,
			final long minPkgSize, final long maxPkgSize, final long uncmpVideoFrameSize) {
	...
	/**
	 * This method converts {@link #getDuration()} from 100ns steps to normal seconds with a fractional part taking
	 * milliseconds.<br>
	 * 
	 * @return The duration of the media in seconds (with a precision of milliseconds)
	 */
