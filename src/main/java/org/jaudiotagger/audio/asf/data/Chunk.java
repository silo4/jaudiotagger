 ...
 * Each chunk starts with a 16byte {@linkplain GUID GUID} identifying the type. After that a number (represented by 8
 * bytes) follows which shows the size in bytes of the chunk. Finally there is the data of the chunk.
 * 
...
public class Chunk {
	...
	/**
	 * This method creates a String containing useful information prepared to be printed on STD-OUT. <br>
