...
class EncryptionChunkReader implements ChunkReader {
	...
	public Chunk read(final GUID guid, final InputStream stream, final long chunkStart) throws IOException {
		...
		/*
		 * Object ID GUID 128 Object Size QWORD 64 Secret Data Length DWORD 32 Secret Data INTEGER varies Protection
		 * Type Length DWORD 32 Protection Type char varies Key ID Length DWORD 32 Key ID char varies License URL Length
		 * DWORD 32 License URL char varies * Read the
		 */
		byte[] secretData;
		byte[] protectionType;
		byte[] keyID;
