...
/**
 * Implementors can write themselves directly to an output stream, and have the ability to tell the size they would
 * need, as well as determine if they are empty.<br>
 * 
