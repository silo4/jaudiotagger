 ...
 * So at each time, with {@link #getReadCount()} one can determine how many bytes have been read, by this classes read
 * and skip methods (mark and reset are also taken into account).<br>
 * 
...
class CountingInputStream extends FilterInputStream {
	...
	/**
	 * If {@link #mark(int)} has been called, the current value of {@link #readCount} is stored, in order to reset it
	 * upon {@link #reset()}.
	 */
