...
public class OggFileReader extends AudioFileReader {
	 ...
	 * <p/>
	 * count=0; should return PageHeader that contains Vorbis Identification Header count=1; should return Pageheader
	 * that contains VorbisComment and possibly SetupHeader count>=2; should return PageHeader containing remaining
	 * VorbisComment,SetupHeader and/or Audio
	 * 
	 * @param raf
	 * @param count
	 * @return
	 ...
	 * @throws IOException
	 */
	public OggPageHeader readOggPageHeader(final RandomAccessFile raf, int count) throws CannotReadException, IOException {
	 ...
	 * @throws IOException
	 */
	public void summarizeOggPageHeaders(final Path oggFile) throws CannotReadException, IOException {
		final RandomAccessFile raf = new RandomAccessFile(oggFile.toFile(), "r");
	 ...
	 * @throws IOException
	 */
	public void shortSummarizeOggPageHeaders(final Path oggFile) throws CannotReadException, IOException {
		final RandomAccessFile raf = new RandomAccessFile(oggFile.toFile(), "r");
