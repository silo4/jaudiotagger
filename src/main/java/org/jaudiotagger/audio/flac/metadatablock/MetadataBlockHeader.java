...
public class MetadataBlockHeader {
	 ...
	 * @throws IOException
	 */
	public static MetadataBlockHeader readHeader(final RandomAccessFile raf) throws IOException {
		final ByteBuffer rawdata = ByteBuffer.allocate(HEADER_LENGTH);
	 ...
	 * @param rawdata
	 */
	public MetadataBlockHeader(final ByteBuffer rawdata) {
		isLastBlock = ((rawdata.get(0) & 0x80) >>> 7) == 1;

		final int type = rawdata.get(0) & 0x7F;
