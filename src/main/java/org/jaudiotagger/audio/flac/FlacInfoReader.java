...
public class FlacInfoReader {
	...
	public FlacAudioHeader read(final RandomAccessFile raf) throws CannotReadException, IOException {
		...
		final FlacAudioHeader info = new FlacAudioHeader();
	...
	private int computeBitrate(final float length, final long size) {
	 ...
	 * @throws IOException
	 */
	public int countMetaBlocks(final Path f) throws CannotReadException, IOException {
		final RandomAccessFile raf = new RandomAccessFile(f.toFile(), "r");
		final FlacStreamReader flacStream = new FlacStreamReader(raf);
		flacStream.findStream();
