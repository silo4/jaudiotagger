 ...
 * allowable but seeing as seems to cccur in files encoded with iTunes 6 and players such as Winamp and iTunes deal with
 * it we should
 * 
...
public class NullPadding extends Mp4BoxHeader {
	...
	public NullPadding(final long startPosition, final long fileSize) {
