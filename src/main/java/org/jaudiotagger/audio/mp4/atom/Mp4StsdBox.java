 ...
 * <p/>
 * <p>
 * 4 bytes version/flags = byte hex version + 24-bit hex flags (current = 0) - > 4 bytes number of descriptions = long
 * unsigned total (default = 1) Then if audio contains mp4a,alac or drms box
 */
public class Mp4StsdBox extends AbstractMp4Box {
	 ...
	 */
	public Mp4StsdBox(final Mp4BoxHeader header, final ByteBuffer dataBuffer) {
		this.header = header;
