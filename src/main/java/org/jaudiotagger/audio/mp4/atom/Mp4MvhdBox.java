 ...
 * <p/>
 * <p>
 * This MP4Box contains important audio information we need. It can be used to calculate track length, depending on the
 * version field this can be in either short or long format
 */
public class Mp4MvhdBox extends AbstractMp4Box {
	 ...
	 */
	public Mp4MvhdBox(final Mp4BoxHeader header, final ByteBuffer dataBuffer) {
		this.header = header;
		final byte version = dataBuffer.get(VERSION_FLAG_POS);
