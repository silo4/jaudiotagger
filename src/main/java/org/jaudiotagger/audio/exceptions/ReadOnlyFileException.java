...
public class ReadOnlyFileException extends Exception {
	...
	public ReadOnlyFileException(final Throwable ex) {
		super(ex);
	}
	 ...
	 *            the detail message.
	 */
	public ReadOnlyFileException(final String msg) {
		super(msg);
	}

	public ReadOnlyFileException(final String msg, final Throwable ex) {
		super(msg, ex);
	}
}
