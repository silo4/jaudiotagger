...
/**
 * This class provides common functionality for NameChunk, AuthorChunk, and CopyrightChunk
 */
public abstract class TextChunk extends Chunk {
	 ...
	 */
	public TextChunk(final ChunkHeader hdr, final RandomAccessFile raf) {
		super(raf, hdr);
	}
