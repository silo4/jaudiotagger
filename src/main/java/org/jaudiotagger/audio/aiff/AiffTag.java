...
public class AiffTag extends GenericTag {
	...
	private class AiffTagTextField implements TagTextField {
		 ...
		 *            The string.
		 */
		public AiffTagTextField(final String fieldId, final String initialContent) {
			this.id = fieldId;
	...
	public boolean hasField(final AiffTagFieldKey fieldKey) {
	 ...
	 */
	public void setField(final AiffTagFieldKey genericKey, final String value) throws KeyNotFoundException, FieldDataInvalidException {
		final TagField tagfield = createField(genericKey, value);
		setField(tagfield);
	}

	public TagField createField(final AiffTagFieldKey genericKey, final String value) throws KeyNotFoundException, FieldDataInvalidException {
