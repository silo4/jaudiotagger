...
public class ModificationHandler implements AudioFileModificationListener {
	 ...
	 *            Listener to add.
	 */
	public void addAudioFileModificationListener(final AudioFileModificationListener l) {
	...
	public void fileModified(final AudioFile original, final Path temporary) throws ModifyVetoException {
		for (final AudioFileModificationListener listener : this.listeners) {
			final AudioFileModificationListener current = listener;
			try {
				current.fileModified(original, temporary);
			} catch (final ModifyVetoException e) {
	 ...
	 *            Listener to remove.
	 */
	public void removeAudioFileModificationListener(final AudioFileModificationListener l) {
		if (this.listeners.contains(l))
