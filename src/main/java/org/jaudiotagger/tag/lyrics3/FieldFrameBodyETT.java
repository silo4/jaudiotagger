...
public class FieldFrameBodyETT extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyETT(final FieldFrameBodyETT body) {
		super(body);
	}
	 ...
	 * @param title
	 */
	public FieldFrameBodyETT(final String title) {
	 ...
	 */
	public FieldFrameBodyETT(final ByteBuffer byteBuffer) throws InvalidTagException {
