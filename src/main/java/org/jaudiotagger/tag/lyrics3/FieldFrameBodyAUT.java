...
public class FieldFrameBodyAUT extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyAUT(final FieldFrameBodyAUT body) {
		super(body);
	}
	 ...
	 * @param author
	 */
	public FieldFrameBodyAUT(final String author) {
	 ...
	 */
	public FieldFrameBodyAUT(final ByteBuffer byteBuffer) throws InvalidTagException {
