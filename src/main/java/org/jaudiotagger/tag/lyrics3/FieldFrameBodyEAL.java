...
public class FieldFrameBodyEAL extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyEAL(final FieldFrameBodyEAL body) {
		super(body);
	}
	 ...
	 * @param album
	 */
	public FieldFrameBodyEAL(final String album) {
	 ...
	 */
	public FieldFrameBodyEAL(final ByteBuffer byteBuffer) throws InvalidTagException {
		read(byteBuffer);
