...
public class FieldFrameBodyEAR extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyEAR(final FieldFrameBodyEAR body) {
		super(body);
	}
	 ...
	 * @param artist
	 */
	public FieldFrameBodyEAR(final String artist) {
	 ...
	 */
	public FieldFrameBodyEAR(final ByteBuffer byteBuffer) throws InvalidTagException {
