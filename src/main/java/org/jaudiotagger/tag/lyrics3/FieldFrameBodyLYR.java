...
public class FieldFrameBodyLYR extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyLYR(final FieldFrameBodyLYR copyObject) {
		super(copyObject);
	 ...
	 * @param line
	 */
	public FieldFrameBodyLYR(final String line) {
		readString(line);
	}
	 ...
	 * @param sync
	 */
	public FieldFrameBodyLYR(final FrameBodySYLT sync) {
		addLyric(sync);
	}
	 ...
	 * @param unsync
	 */
	public FieldFrameBodyLYR(final FrameBodyUSLT unsync) {
		addLyric(unsync);
	}
	 ...
	 */
	public FieldFrameBodyLYR(final ByteBuffer byteBuffer) throws InvalidTagException {
	...
	public boolean isSubsetOf(final Object obj) {
		...
		final ArrayList<Lyrics3Line> superset = ((FieldFrameBodyLYR) obj).lines;
	...
	public void addLyric(final FrameBodySYLT sync) {
		...
		final Iterator<ID3v2LyricLine> iterator = sync.iterator();
		Lyrics3Line newLine;
		ID3v2LyricLine currentLine;
		Lyrics3TimeStamp timeStamp;
		final HashMap<String, Lyrics3Line> lineMap = new HashMap<String, Lyrics3Line>();
	...
	public void addLyric(final FrameBodyUSLT unsync) {
		...
		final Lyrics3Line line = new Lyrics3Line("Lyric Line", this);
	...
	public boolean equals(final Object obj) {
		...
		final FieldFrameBodyLYR object = (FieldFrameBodyLYR) obj;
