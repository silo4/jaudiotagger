...
public class FieldFrameBodyIND extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyIND(final FieldFrameBodyIND body) {
		super(body);
	}
	 ...
	 */
	public FieldFrameBodyIND(final boolean lyricsPresent, final boolean timeStampPresent) {
	 ...
	 */
	public FieldFrameBodyIND(final ByteBuffer byteBuffer) throws InvalidTagException {
