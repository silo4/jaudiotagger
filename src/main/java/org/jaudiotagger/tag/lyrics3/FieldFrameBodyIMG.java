...
public class FieldFrameBodyIMG extends AbstractLyrics3v2FieldFrameBody {
	...
	public FieldFrameBodyIMG(final FieldFrameBodyIMG copyObject) {
		super(copyObject);
	 ...
	 * @param imageString
	 */
	public FieldFrameBodyIMG(final String imageString) {
	 ...
	 * @param image
	 */
	public FieldFrameBodyIMG(final Lyrics3Image image) {
		images.add(image);
	}
	 ...
	 */
	public FieldFrameBodyIMG(final ByteBuffer byteBuffer) throws InvalidTagException {
	...
	public int getSize() {
		...
		for (final Object image1 : images) {
	...
	public boolean isSubsetOf(final Object obj) {
		...
		final ArrayList<Lyrics3Image> superset = ((FieldFrameBodyIMG) obj).images;
	 ...
	 * @param image
	 */
	public void addImage(final Lyrics3Image image) {
		images.add(image);
	}
	...
	public boolean equals(final Object obj) {
		...
		final FieldFrameBodyIMG object = (FieldFrameBodyIMG) obj;
