...
public class Lyrics3v2Field extends AbstractTagFrame {
	 ...
	 * @param body
	 */
	public Lyrics3v2Field(final AbstractLyrics3v2FieldFrameBody body) {
		this.frameBody = body;
	}
	 ...
	 * @param byteBuffer
	 */
	public Lyrics3v2Field(final ByteBuffer byteBuffer) throws InvalidTagException {
	 ...
	 * @throws InvalidTagException
	 */
	private AbstractLyrics3v2FieldFrameBody readBody(final String identifier, final ByteBuffer byteBuffer) throws InvalidTagException {
