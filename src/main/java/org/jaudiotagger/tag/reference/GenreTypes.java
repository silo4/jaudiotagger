 ...
 * <p/>
 * <p>
 * This is the IDv1 list with additional values as defined by Winamp, this list is also used in Mp4 files, note iTunes
 * doesn't understand genres above MAX_STANDARD_GENRE_ID, Winamp does
 * </p>
 */
public class GenreTypes extends AbstractIntStringValuePair {
	...
	private GenreTypes() {
		...
		for (final Map.Entry<Integer, String> entry : idToValue.entrySet())
	 ...
	 * @return
	 */
	public Integer getIdForName(final String name) {
