...
public class EmptyFrameException extends InvalidFrameException {
	 ...
	 *            the cause.
	 */
	public EmptyFrameException(final Throwable ex) {
		super(ex);
	}
	 ...
	 *            the detail message.
	 */
	public EmptyFrameException(final String msg) {
		super(msg);
	}
	 ...
	 *            the cause.
	 */
	public EmptyFrameException(final String msg, final Throwable ex) {
		super(msg, ex);
	}
}
