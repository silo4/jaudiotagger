...
/**
 * Represents a String whose size is determined by finding of a null character at the end of the String with fixed text
 * encoding.
 * <p/>
...
public class StringNullTerminated extends TextEncodedStringNullTerminated {
	 ...
	 * @param frameBody
	 */
	public StringNullTerminated(final String identifier, final AbstractTagFrameBody frameBody) {
		super(identifier, frameBody);
	}

	public StringNullTerminated(final StringNullTerminated object) {
		super(object);
	}
