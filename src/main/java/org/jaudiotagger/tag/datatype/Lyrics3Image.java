...
public class Lyrics3Image extends AbstractDataType {
	 ...
	 * @param frameBody
	 */
	public Lyrics3Image(final String identifier, final AbstractTagFrameBody frameBody) {
		super(identifier, frameBody);
	}

	public Lyrics3Image(final Lyrics3Image copy) {
		super(copy);
	...
	public boolean equals(final Object obj) {
		...
		final Lyrics3Image object = (Lyrics3Image) obj;
		...
		if (this.time == null) {
			if (object.time != null)
				return false;
		} else if (!this.time.equals(object.time))
			return false;
