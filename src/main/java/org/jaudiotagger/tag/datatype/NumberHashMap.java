...
public class NumberHashMap extends NumberFixedLength implements HashMapInterface<Integer, String> {
	 ...
	 */
	public NumberHashMap(final String identifier, final AbstractTagFrameBody frameBody, final int size) {
	...
	public NumberHashMap(final NumberHashMap copyObject) {
		super(copyObject);
	...
	public boolean equals(final Object obj) {
		...
		final NumberHashMap that = (NumberHashMap) obj;

		return EqualsUtil.areEqual(hasEmptyValue, that.hasEmptyValue) && EqualsUtil.areEqual(keyToValue, that.keyToValue) && EqualsUtil.areEqual(valueToKey, that.valueToKey) && super.equals(that);
	}
	...
	public void readByteArray(final byte[] arr, final int offset) throws InvalidDataTypeException {
		...
		final Integer intValue = ((Long) value).intValue();
