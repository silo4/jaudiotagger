...
public class BooleanByte extends AbstractDataType {
	 ...
	 */
	public BooleanByte(final String identifier, final AbstractTagFrameBody frameBody, final int bitPosition) {
	...
	public BooleanByte(final BooleanByte copy) {
		super(copy);
	...
	public boolean equals(final Object obj) {
		...
		final BooleanByte object = (BooleanByte) obj;
