...
public class NumberVariableLength extends AbstractDataType {
	 ...
	 * @param minimumSize
	 */
	public NumberVariableLength(final String identifier, final AbstractTagFrameBody frameBody, final int minimumSize) {
	...
	public NumberVariableLength(final NumberVariableLength copy) {
		super(copy);
	...
	public boolean equals(final Object obj) {
		...
		final NumberVariableLength object = (NumberVariableLength) obj;
	...
	public void readByteArray(final byte[] arr, final int offset) throws InvalidDataTypeException {
		...
		// If optional then set value to zero, this will mean that if this frame is written back to file it will be
		// created
		...
		// Read the bytes (starting from offset), the most significant byte of the number being constructed is read
		// first,
