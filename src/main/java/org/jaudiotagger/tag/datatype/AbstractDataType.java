...
/**
 * Represents a field/data type that can be held within a frames body, these map loosely onto Section 4. ID3v2 frame
 * overview at http://www.id3.org/id3v2.4.0-structure.txt
 */
public abstract class AbstractDataType {
	...
	/**
	 * Holds the key such as "Text" or "PictureType", the naming of keys are fairly arbitary but are intended to make it
	 * easier to for the developer, the keys themseleves are not written to the tag.
	 */
	protected String identifier = "";

	/**
	 * Holds the calling body, allows an datatype to query other objects in the body such as the Text Encoding of the
	 * frame
	 */
	...
	/**
	 * Construct an abstract datatype identified by identifier and linked to a framebody without setting an initial
	 * value.
	 * 
	 * @param identifier
	 *            to allow retrieval of this datatype by name from framebody
	 * @param frameBody
	 *            that the dataype is associated with
	 */
	protected AbstractDataType(final String identifier, final AbstractTagFrameBody frameBody) {
	 ...
	 *            of this DataType
	 */
	protected AbstractDataType(final String identifier, final AbstractTagFrameBody frameBody, final Object value) {
		this.identifier = identifier;
		this.frameBody = frameBody;
		setValue(value);
	}
	 ...
	 * @param copyObject
	 */
	public AbstractDataType(final AbstractDataType copyObject) {
	...
	/**
	 * Set the value held by this datatype, this is used typically used when the user wants to modify the value in an
	 * existing frame.
	 * 
	 * @param value
	 */
	...
	/**
	 * Simplified wrapper for reading bytes from file into Object. Used for reading Strings, this class should be
	 * overridden for non String Objects
	 * 
	 * @param arr
	 * @throws org.jaudiotagger.tag.InvalidDataTypeException
	 */
	final public void readByteArray(final byte[] arr) throws InvalidDataTypeException {
		readByteArray(arr, 0);
	}
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof AbstractDataType))
			return false;
		final AbstractDataType object = (AbstractDataType) obj;
	...
	/**
	 * This is the starting point for reading bytes from the file into the ID3 datatype starting at offset. This class
	 * must be overridden
	 * 
	 * @param arr
	 * @param offset
