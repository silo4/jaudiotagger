 ...
 * the byte array will be read, when writing the frame will accommodate the required size for the String. The String
 * will be encoded using the default encoding regardless of what encoding may be specified in the framebody
 */
public class StringSizeTerminated extends TextEncodedStringSizeTerminated {
	 ...
	 * @param frameBody
	 */
	public StringSizeTerminated(final String identifier, final AbstractTagFrameBody frameBody) {
		super(identifier, frameBody);
	}

	public StringSizeTerminated(final StringSizeTerminated object) {
		super(object);
	}
