...
public class MultipleTextEncodedStringNullTerminated extends AbstractDataType {
	 ...
	 * @param frameBody
	 */
	public MultipleTextEncodedStringNullTerminated(final String identifier, final AbstractTagFrameBody frameBody) {
		super(identifier, frameBody);
		value = new MultipleTextEncodedStringNullTerminated.Values();
	}

	public MultipleTextEncodedStringNullTerminated(final TextEncodedStringSizeTerminated object) {
		super(object);
		value = new MultipleTextEncodedStringNullTerminated.Values();
	}

	public MultipleTextEncodedStringNullTerminated(final MultipleTextEncodedStringNullTerminated object) {
		super(object);
	}
	...
	public boolean canBeEncoded() {
		for (final ListIterator<String> li = ((Values) value).getList().listIterator(); li.hasNext();) {
			final TextEncodedStringNullTerminated next = new TextEncodedStringNullTerminated(identifier, frameBody, li.next());
	...
	public static class Values {
		...
		public String toString() {
			...
			for (final ListIterator<String> li = valueList.listIterator(); li.hasNext();) {
				final String next = li.next();
				sb.append(next);
				if (li.hasNext())
					sb.append(",");
			}
