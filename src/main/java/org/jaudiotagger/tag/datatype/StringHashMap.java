...
/**
 * Represents a String thats acts as a key into an enumeration of values. The String will be encoded using the default
 * encoding regardless of what encoding may be specified in the framebody
 */
public class StringHashMap extends StringFixedLength implements HashMapInterface<String, String> {
	 ...
	 */
	public StringHashMap(final String identifier, final AbstractTagFrameBody frameBody, final int size) {
	...
	public StringHashMap(final StringHashMap copyObject) {
		super(copyObject);
	...
	public boolean equals(final Object obj) {
		...
		final StringHashMap object = (StringHashMap) obj;
		...
		if (this.keyToValue == null) {
			if (object.keyToValue != null)
				return false;
		} else if (!this.keyToValue.equals(object.keyToValue))
			return false;

		if (this.keyToValue == null) {
			if (object.keyToValue != null)
				return false;
		} else if (!this.valueToKey.equals(object.valueToKey))
			return false;
	...
	public Iterator<String> iterator() {
		if (keyToValue == null)
			...
			final TreeSet<String> treeSet = new TreeSet<String>(keyToValue.values());
