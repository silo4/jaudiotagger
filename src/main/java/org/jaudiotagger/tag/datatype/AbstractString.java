...
public abstract class AbstractString extends AbstractDataType {
	 ...
	 * @param frameBody
	 */
	protected AbstractString(final String identifier, final AbstractTagFrameBody frameBody) {
	 ...
	 * @param value
	 */
	public AbstractString(final String identifier, final AbstractTagFrameBody frameBody, final String value) {
	 ...
	 * @param object
	 */
	protected AbstractString(final AbstractString object) {
		super(object);
	}
	...
	/**
	 * Sets the size in bytes of this data type. This is set after writing the data to allow us to recalculate the size
	 * for frame header.
	 * 
	 * @param size
	 */
