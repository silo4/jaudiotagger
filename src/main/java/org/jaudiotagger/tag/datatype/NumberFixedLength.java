...
public class NumberFixedLength extends AbstractDataType {
	 ...
	 * @param frameBody
	 * @param size
	 *            the number of significant places that the number is held to
	 * @throws IllegalArgumentException
	 */
	public NumberFixedLength(final String identifier, final AbstractTagFrameBody frameBody, final int size) {
	...
	public NumberFixedLength(final NumberFixedLength copy) {
		super(copy);
		this.size = copy.size;
	}
	 ...
	 * 
	 * @param size
	 *            in bytes that this number will be held as
	 */
	...
	public boolean equals(final Object obj) {
		if (!(obj instanceof NumberFixedLength))
			return false;
		final NumberFixedLength object = (NumberFixedLength) obj;
