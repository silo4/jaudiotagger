...
public class Mp4TagTextField extends Mp4TagField implements TagTextField {
	 ...
	 */
	public Mp4TagTextField(final String id, final ByteBuffer data) throws UnsupportedEncodingException {
		super(id, data);
	}
	 ...
	 *            data atom data
	 */
	public Mp4TagTextField(final String id, final String content) {
		super(id);
