...
public class Mp4TagBinaryField extends Mp4TagField {
	 ...
	 * @param id
	 */
	public Mp4TagBinaryField(final String id) {
		super(id);
	}
	 ...
	 */
	public Mp4TagBinaryField(final String id, final byte[] data) {
		super(id);
		this.dataBytes = data;
	}
	 ...
	 * @throws UnsupportedEncodingException
	 */
	public Mp4TagBinaryField(final String id, final ByteBuffer raw) throws UnsupportedEncodingException {
		super(id, raw);
	}
