...
public class Mp4TagByteField extends Mp4TagTextField {
	...
	// items because we cant accurately work out the size by looking at the content because sometimes field must be
	// longer
	 ...
	 */
	public Mp4TagByteField(final Mp4FieldKey id, final String value) throws FieldDataInvalidException {
		this(id, value, 1);
	}
	 ...
	 * @throws org.jaudiotagger.tag.FieldDataInvalidException
	 */
	public Mp4TagByteField(final Mp4FieldKey id, final String value, final int realDataLength) throws FieldDataInvalidException {
	 ...
	 */
	public Mp4TagByteField(final String id, final ByteBuffer raw) throws UnsupportedEncodingException {
		super(id, raw);
	}
	...
	protected byte[] getDataBytes() throws UnsupportedEncodingException {
		...
		case 2: {
			// Save as two bytes
			final Short shortValue = new Short(content);
			final byte rawData[] = Utils.getSizeBEInt16(shortValue);
			return rawData;
		}
		case 1: {
			// Save as 1 bytes
		...
		case 4: {
			// Assume could be int
			final Integer intValue = new Integer(content);
			final byte rawData[] = Utils.getSizeBEInt32(intValue);
			return rawData;
		}
		default: {
			// TODO
