...
public enum Mp4FieldType {
	...
	TEXT(0x1), // UTF-8
	TEXT_UTF16BE(0x02), TEXT_JAPANESE(0x03), HTML(0x06), XML(0x07), GUID(0x08), ISRC(0x09), MI3P(0x0a), COVERART_GIF(0x0c), COVERART_JPEG(0x0d), COVERART_PNG(0x0e), URL(0x0f), DURATION(0x10), DATETIME(0x11), GENRES(0x12), INTEGER(0x15), // Formally
																																																												// known
																																																												// as
																																																												// byte
	...
	Mp4FieldType(final int fileClassId) {
	...
	static {
		...
		for (final Mp4FieldType curr : Mp4FieldType.values())
	 ...
	 */
	public static Mp4FieldType getFieldType(final int fieldClassId) {
	 ...
	 */
	public static boolean isCoverArtType(final Mp4FieldType mp4FieldType) {
