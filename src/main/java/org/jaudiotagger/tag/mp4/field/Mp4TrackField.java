 ...
 * <p/>
 * <p>
 * There are a number of reserved fields making matters more complicated Reserved:2 bytes Track Number:2 bytes No of
 * Tracks:2 bytes (or zero if not known) PlayListTitleReserved: 1 byte playtitlenameReserved:0 bytes
 * </p>
 */
public class Mp4TrackField extends Mp4TagTextNumberField {
	 ...
	 */
	public Mp4TrackField(final String trackValue) throws FieldDataInvalidException {
		super(Mp4FieldKey.TRACK.getFieldName(), trackValue);

		numbers = new ArrayList<Short>();
		numbers.add(new Short("0"));

		final String values[] = trackValue.split("/");
	 ...
	 * @param trackNo
	 */
	public Mp4TrackField(final int trackNo) {
	 ...
	 * @param total
	 */
	public Mp4TrackField(final int trackNo, final int total) {
		super(Mp4FieldKey.TRACK.getFieldName(), String.valueOf(trackNo));
		numbers = new ArrayList<Short>();
		numbers.add(new Short("0"));
		numbers.add((short) trackNo);
	 ...
	 */
	public Mp4TrackField(final String id, final ByteBuffer data) throws UnsupportedEncodingException {
		super(id, data);
	}
	 ...
	 * @param trackTotal
	 */
	public void setTrackTotal(final int trackTotal) {
