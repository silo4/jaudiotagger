...
public class Mp4TagTextNumberField extends Mp4TagTextField {
	 ...
	 * @param numberArray
	 */
	public Mp4TagTextNumberField(final String id, final String numberArray) {
		super(id, numberArray);
	}

	public Mp4TagTextNumberField(final String id, final ByteBuffer data) throws UnsupportedEncodingException {
		super(id, data);
	}
