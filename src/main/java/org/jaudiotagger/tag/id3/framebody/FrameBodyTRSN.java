 ...
 * <p>
 * The 'Internet radio station name' frame contains the name of the internet radio station from which the audio is
 * streamed.
 * <p/>
 * <p>
...
public class FrameBodyTRSN extends AbstractFrameBodyTextInfo implements ID3v23FrameBody, ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTRSN(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
