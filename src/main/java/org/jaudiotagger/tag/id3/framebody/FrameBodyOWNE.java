 ...
 * <p/>
 * <p/>
 * The ownership frame might be used as a reminder of a made transaction or, if signed, as proof. Note that the "USER"
 * and "TOWN" frames are good to use in conjunction with this one. The frame begins, after the frame ID, size and
 * encoding fields, with a 'price payed' field. The first three characters of this field contains the currency used for
 * the transaction, encoded according to ISO-4217 alphabetic currency code. Concatenated to this is the actual price
 * payed, as a numerical string using "." as the decimal separator. Next is an 8 character date string (YYYYMMDD)
 * followed by a string with the name of the seller as the last field in the frame. There may only be one "OWNE" frame
 * in a tag.
 * </p>
 * <p>
 * <table border=0 width="70%">
 * <tr>
 * <td>&lt;Header for 'Ownership frame', ID: "OWNE"&gt;</td>
 * </tr>
 * <tr>
 * <td>Text encoding</td>
 * <td>$xx</td>
...
public class FrameBodyOWNE extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 * @param seller
	 */
	public FrameBodyOWNE(final byte textEncoding, final String pricePaid, final String dateOfPurchase, final String seller) {
	 ...
	 */
	public FrameBodyOWNE(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
