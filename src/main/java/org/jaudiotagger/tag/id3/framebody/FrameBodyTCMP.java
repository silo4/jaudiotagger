...
public class FrameBodyTCMP extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	...
	public FrameBodyTCMP(final FrameBodyTCMP body) {
		super(body);
	}
	 ...
	 * @param text
	 */
	public FrameBodyTCMP(final byte textEncoding, final String text) {
	 ...
	 */
	public FrameBodyTCMP(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
