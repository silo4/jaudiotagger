 ...
 * <p/>
 * This frame is intended for one-string text information concerning the audio file in a similar way to the other
 * "T"-frames. The frame body consists of a description of the string, represented as a terminated string, followed by
 * the actual string. There may be more than one "TXXX" frame in each tag, but only one with the same description.
 * <p/>
 * <Header for 'User defined text information frame', ID: "TXXX"> Text encoding $xx Description <text string according
 * to encoding> $00 (00) Value <text string according to encoding>
 */
public class FrameBodyTXXX extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 * @param body
	 */
	public FrameBodyTXXX(final FrameBodyTMOO body) {
	 ...
	 */
	public FrameBodyTXXX(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
