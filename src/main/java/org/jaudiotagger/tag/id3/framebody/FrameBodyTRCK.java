 ...
 * 
 * <p>
 * The 'Track number/Position in set' frame is a numeric string containing the order number of the audio-file on its
 * original recording.
 * 
 * This may be extended with a "/" character and a numeric string containing the total number of tracks/elements on the
...
public class FrameBodyTRCK extends AbstractID3v2FrameBody implements ID3v23FrameBody, ID3v24FrameBody {
	...
	public FrameBodyTRCK(final byte textEncoding, final Integer trackNo, final Integer trackTotal) {
		super();
		setObjectValue(DataTypes.OBJ_TEXT_ENCODING, textEncoding);
	 ...
	 */
	public FrameBodyTRCK(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public Integer getTrackNo() {
		final PartOfSet.PartOfSetValue value = (PartOfSet.PartOfSetValue) getObjectValue(DataTypes.OBJ_TEXT);
	...
	public void setTrackNo(final Integer trackNo) {
	...
	public void setTrackTotal(final Integer trackTotal) {
		((PartOfSet.PartOfSetValue) getObjectValue(DataTypes.OBJ_TEXT)).setTotal(trackTotal);
	}

	public void setTrackTotal(final String trackTotal) {
		((PartOfSet.PartOfSetValue) getObjectValue(DataTypes.OBJ_TEXT)).setTotal(trackTotal);
	}
