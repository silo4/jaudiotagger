 ...
 * <p>
 * The 'Original lyricist(s)/text writer(s)' frame is intended for the text writer(s) of the original recording, if for
 * example the music in the file should be a cover of a previously released song. The text writers are seperated with
 * the "/" character.
 * <p/>
 * <p>
...
public class FrameBodyTOLY extends AbstractFrameBodyTextInfo implements ID3v23FrameBody, ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTOLY(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
