 ...
 * <p>
 * The 'Composer(s)' frame is intended for the name of the composer(s). They are separated with the "/" character in
 * ID3v23. Null separated as is the norm in ID3v24
 * 
 * <p/>
 * <p>
...
public class FrameBodyTCOM extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTCOM(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
