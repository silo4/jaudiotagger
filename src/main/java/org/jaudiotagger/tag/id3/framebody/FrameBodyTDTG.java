...
/**
 * <p>
 * The 'Tagging time' frame contains a timestamp describing then the audio was tagged. Timestamp format is described in
 * the ID3v2 structure document
 * </p>
 */
public class FrameBodyTDTG extends AbstractFrameBodyTextInfo implements ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTDTG(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
