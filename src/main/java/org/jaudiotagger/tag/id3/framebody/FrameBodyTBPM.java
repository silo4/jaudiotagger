 ...
 * <p>
 * The 'BPM' frame contains the number of beats per minute in the mainpart of the audio. The BPM is an integer and
...
public class FrameBodyTBPM extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTBPM(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
