...
/**
 * <p>
 * The 'Original release time' frame contains a timestamp describing when the original recording of the audio was
...
public class FrameBodyTDOR extends AbstractFrameBodyTextInfo implements ID3v24FrameBody {
	 ...
	 * @param body
	 */
	public FrameBodyTDOR(final FrameBodyTORY body) {
	 ...
	 */
	public FrameBodyTDOR(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
