 ...
 * <p>
 * The 'Official artist/performer webpage' frame is a URL pointing at the artists official webpage. There may be more
 * than one "WOAR" frame in a tag if the audio contains more than one performer, but not with the same content.
 * <p/>
 * <p>
...
public class FrameBodyWOAR extends AbstractFrameBodyUrlLink implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyWOAR(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
