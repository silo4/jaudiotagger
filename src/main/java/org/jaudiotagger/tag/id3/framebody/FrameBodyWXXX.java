...
public class FrameBodyWXXX extends AbstractFrameBodyUrlLink implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyWXXX(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public String getUrlLinkWithoutTrailingNulls() {
		final TextEncodedStringSizeTerminated text = (TextEncodedStringSizeTerminated) getObject(DataTypes.OBJ_URLLINK);
	 ...
	 */
	public String getUrlLinkAtIndex(final int index) {
		final TextEncodedStringSizeTerminated text = (TextEncodedStringSizeTerminated) getObject(DataTypes.OBJ_URLLINK);
	 ...
	 *            at index
	 */
	public void addUrlLink(final String value) {
		final TextEncodedStringSizeTerminated text = (TextEncodedStringSizeTerminated) getObject(DataTypes.OBJ_URLLINK);
		text.addValue(value);
	}
}
