 ...
 * rather complex but it's an easier solution than if one tries to achieve the same result with several frames. The
 * frame begins, after the frame ID, size and encoding fields, with a price string field. A price is constructed by one
 * three character currency code, encoded according to ISO-4217 alphabetic currency code, followed by a numerical value
 * where "." is used as decimal seperator. In the price string several prices may be concatenated, seperated by a "/"
 * character, but there may only be one currency of each type.
 * </p>
 * <p>
 * The price string is followed by an 8 character date string in the format YYYYMMDD, describing for how long the price
 * is valid. After that is a contact URL, with which the user can contact the seller, followed by a one byte 'received
 * as' field. It describes how the audio is delivered when bought according to the following list:
 * </p>
 * <p>
 ...
 * <tr>
 * <td>$01</td>
 * <td>Standard CD album with other songs</td>
 * </tr>
 * <tr>
 * <td>$02</td>
 * <td>Compressed audio on CD</td>
 * </tr>
 * <tr>
 * <td>$03</td>
 * <td>File over the Internet</td>
 * </tr>
 * <tr>
 * <td>$04</td>
 * <td>Stream over the Internet</td>
 * </tr>
 * <tr>
 * <td>$05</td>
 * <td>As note sheets</td>
 * </tr>
 * <tr>
 * <td>$06</td>
 * <td>As note sheets in a book with other sheets</td>
 * </tr>
 * <tr>
 * <td>$07</td>
 * <td>Music on other media</td>
 * </tr>
 * <tr>
 * <td>$08</td>
 * <td>Non-musical merchandise</td>
 * </tr>
 * </table>
 * </p>
 * <p>
 * Next follows a terminated string with the name of the seller followed by a terminated string with a short description
 * of the product. The last thing is the ability to include a company logotype. The first of them is the 'Picture MIME
 * type' field containing information about which picture format is used. In the event that the MIME media type name is
 * omitted, "image/" will be implied. Currently only "image/png" and "image/jpeg" are allowed. This format string is
 * followed by the binary picture data. This two last fields may be omitted if no picture is to attach.
 * </p>
 * <p>
 * <table border=0 width="70%">
 * <tr>
 * <td colspan=2>&lt;Header for 'Commercial frame', ID: "COMR"&gt;</td>
 * </tr>
 * <tr>
 * <td>Text encoding</td>
 * <td>$xx</td>
...
public class FrameBodyCOMR extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 * @param sellerLogo
	 */
	public FrameBodyCOMR(final byte textEncoding, final String priceString, final String validUntil, final String contactUrl, final byte recievedAs, final String nameOfSeller, final String description, final String mimeType,
	 ...
	 */
	public FrameBodyCOMR(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
