 ...
 * <p>
 * The 'Recording dates' frame is a intended to be used as complement to the "TYER", "TDAT" and "TIME" frames. E.g.
...
public class FrameBodyTRDA extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTRDA(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
