 ...
 * ID3v2ExtensionFrameBody Interface which should be implemented by frame bodies that are non standard such as iTunes
 * compilation frame (TCMP) but are commonly used.
 */
public class FrameBodyUnsupported extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody, ID3v22FrameBody {
	 ...
	 * @param identifier
	 */
	public FrameBodyUnsupported(final String identifier) {
	 ...
	 * @param value
	 */
	public FrameBodyUnsupported(final String identifier, final byte[] value) {
		this.identifier = identifier;
	 ...
	 */
	public FrameBodyUnsupported(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public boolean equals(final Object obj) {
		...
		final FrameBodyUnsupported object = (FrameBodyUnsupported) obj;
