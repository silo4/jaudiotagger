 ...
 * terminated string. If no descriptor is entered, 'Content descriptor' is $00 (00) only. Newline characters are allowed
 * in the text. There may be more than one 'Unsynchronised lyrics/text transcription' frame in each tag, but only one
 ...
 * <tr>
 * <td colspan=2>&lt;Header for 'Unsynchronised lyrics/text transcription', ID: "USLT"&gt;</td>
 * </tr>
 * <tr>
 * <td>Text encoding</td>
 * <td width="80%">$xx</td>
...
public class FrameBodyUSLT extends AbstractID3v2FrameBody implements ID3v23FrameBody, ID3v24FrameBody {
	 ...
	 * @throws InvalidTagException
	 */
	public FrameBodyUSLT(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public String getFirstTextValue() {
		final TextEncodedStringSizeTerminated text = (TextEncodedStringSizeTerminated) getObject(DataTypes.OBJ_LYRICS);
	 ...
	 * @param line
	 */
	public void addLyric(final Lyrics3Line line) {
