 ...
 * earlier tag version. The body consists of an array of bytes representing all the bytes in the body.
 */
public class FrameBodyDeprecated extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	/**
	 * The original frameBody is held so can be retrieved when converting a DeprecatedFrameBody back to a normal
	 * framebody
	 */
	 ...
	 * @param frameBody
	 */
	public FrameBodyDeprecated(final AbstractID3v2FrameBody frameBody) {
	 ...
	 */
	public FrameBodyDeprecated(final FrameBodyDeprecated copyObject) {
		super(copyObject);
	}
	...
	public boolean equals(final Object obj) {
		...
		final FrameBodyDeprecated object = (FrameBodyDeprecated) obj;
