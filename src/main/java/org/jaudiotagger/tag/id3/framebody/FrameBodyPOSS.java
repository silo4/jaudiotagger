 ...
 * <p/>
 * <p/>
 * This frame delivers information to the listener of how far into the audio stream he picked up; in effect, it states
 ...
 * <tr>
 * <td colspan=2>&lt;Head for 'Position synchronisation', ID: "POSS"&gt;</td>
 * </tr>
 * <tr>
 ...
 * </p>
 * <p>
 * and position is where in the audio the listener starts to receive, i.e. the beginning of the next frame. If this
 * frame is used in the beginning of a file the value is always 0. There may only be one "POSS" frame in each tag.
 * </p>
 * <p/>
 * <p>
...
public class FrameBodyPOSS extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyPOSS(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
