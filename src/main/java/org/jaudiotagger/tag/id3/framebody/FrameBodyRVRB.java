 ...
 * <p/>
 * <p/>
 * Yet another subjective one. You may here adjust echoes of different kinds. Reverb left/right is the delay between
 * every bounce in ms. Reverb bounces left/right is the number of bounces that should be made. $FF equals an infinite
 * number of bounces. Feedback is the amount of volume that should be returned to the next echo bounce. $00 is 0%, $FF
 * is 100%. If this value were $7F, there would be 50% volume reduction on the first bounce, 50% of that on the second
 * and so on. Left to left means the sound from the left bounce to be played in the left speaker, while left to right
 * means sound from the left bounce to be played in the right speaker.
 * </p>
 * <p>
 * 'Premix left to right' is the amount of left sound to be mixed in the right before any reverb is applied, where $00
 * id 0% and $FF is 100%. 'Premix right to left' does the same thing, but right to left. Setting both premix to $FF
 * would result in a mono output (if the reverb is applied symmetric). There may only be one "RVRB" frame in each tag.
 * </p>
 * <p>
 * <table border=0 width="70%">
 * <tr>
 * <td colspan=2>&lt;Header for 'Reverb', ID: "RVRB"&gt;</td>
 * </tr>
 * <tr>
 * <td>Reverb left (ms)</td>
 * <td>$xx xx</td>
 * </tr>
 * <tr>
 * <td>Reverb right (ms)</td>
 * <td>$xx xx</td>
 * </tr>
 * <tr>
 * <td>Reverb bounces, left</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Reverb bounces, right</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Reverb feedback, left to left</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Reverb feedback, left to right</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Reverb feedback, right to right</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Reverb feedback, right to left</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Premix left to right</td>
 * <td>$xx</td>
 * </tr>
 * <tr>
 * <td>Premix right to left</td>
 * <td>$xx</td>
 * </tr>
 * </table>
 * </p>
...
public class FrameBodyRVRB extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyRVRB(final short reverbLeft, final short reverbRight, final byte reverbBouncesLeft, final byte reverbBouncesRight, final byte reverbFeedbackLeftToLeft, final byte reverbFeedbackLeftToRight,
			final byte reverbFeedbackRightToRight, final byte reverbFeedbackRightToLeft, final byte premixLeftToRight, final byte premixRightToLeft) {
	 ...
	 */
	public FrameBodyRVRB(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
