 ...
 * <p>
 * The 'Internet radio station owner' frame contains the name of the owner of the internet radio station from which the
 * audio is streamed.
 * <p/>
 * <p>
...
public class FrameBodyTRSO extends AbstractFrameBodyTextInfo implements ID3v23FrameBody, ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTRSO(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
