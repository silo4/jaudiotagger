...
public class FrameBodyTIPL extends AbstractID3v2FrameBody implements ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTIPL(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	 ...
	 * @param body
	 */
	public FrameBodyTIPL(final FrameBodyIPLS body) {
	 ...
	 * @param name
	 */
	public void addPair(final String function, final String name) {
