...
public abstract class AbstractFrameBodyUrlLink extends AbstractID3v2FrameBody {
	 ...
	 * @param urlLink
	 */
	public AbstractFrameBodyUrlLink(final String urlLink) {
	 ...
	 */
	protected AbstractFrameBodyUrlLink(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public void write(final ByteArrayOutputStream tagBuffer) {
		final CharsetEncoder encoder = Charset.forName(TextEncoding.CHARSET_ISO_8859_1).newEncoder();
		final String origUrl = getUrlLink();
