 ...
 * maximum length of three characters. The ground keys are represented with "A","B","C","D","E", "F" and "G" and
 * halfkeys represented with "b" and "#". Minor is represented as "m". Example "Cbm". Off key is represented with an "o"
 * only.
 * <p/>
 * <p>
...
public class FrameBodyTKEY extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTKEY(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
