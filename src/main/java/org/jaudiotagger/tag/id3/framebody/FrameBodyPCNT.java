 ...
 * <p/>
 * <p/>
 * This is simply a counter of the number of times a file has been played. The value is increased by one every time the
 * file begins to play. There may only be one "PCNT" frame in each tag. When the counter reaches all one's, one byte is
 * inserted in front of the counter thus making the counter eight bits bigger. The counter must be at least 32-bits long
 * to begin with.
 * </p>
 * <p>
 * <table border=0 width="70%">
 * <tr>
 * <td colspan=2>&lt;Header for 'Play counter', ID: "PCNT"&gt;</td>
 * </tr>
 * <tr>
 * <td>Counter</td>
...
public class FrameBodyPCNT extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyPCNT(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
