 ...
 * <p>
 * The 'Time' frame is a numeric string in the HHMM format containing the time for the recording. This field is always
...
public class FrameBodyTIME extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTIME(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
