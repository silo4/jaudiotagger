...
public class FrameBodyTDRC extends AbstractFrameBodyTextInfo implements ID3v24FrameBody {
	...
	/**
	 * When this has been generated as an amalgamation of v3 frames assumes the v3 frames match the the format in
	 * specification and convert them to their equivalent v4 format and return the generated String. i.e if the v3
	 * frames contain a valid value this will return a valid v4 value, if not this won't.
	 */
	 ...
	 * @return
	 */
	private static synchronized String formatAndParse(final SimpleDateFormat formatDate, final SimpleDateFormat parseDate, final String text) {
		try {
			final Date date = parseDate.parse(text);
			final String result = formatDate.format(date);
			return result;
	 ...
	 * @param body
	 */
	public FrameBodyTDRC(final FrameBodyTYER body) {
	 ...
	 * @param body
	 */
	public FrameBodyTDRC(final FrameBodyTIME body) {
	 ...
	 * @param body
	 */
	public FrameBodyTDRC(final FrameBodyTDAT body) {
	 ...
	 * @param body
	 */
	public FrameBodyTDRC(final FrameBodyTRDA body) {
	 ...
	 */
	public FrameBodyTDRC(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	 ...
	 * @return
	 */
	private static synchronized String formatDateAsYear(final Date d) {
	 ...
	 * @return
	 */
	private static synchronized String formatDateAsDate(final Date d) {
	 ...
	 * @return
	 */
	private static synchronized String formatDateAsTime(final Date d) {
	...
	public void setMonthOnly(final boolean monthOnly) {
	...
	public void setHoursOnly(final boolean hoursOnly) {
