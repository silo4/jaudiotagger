 ...
 * example the music in the file should be a cover of a previously released song. The performers are separated with the
 * "/" character.
 * <p/>
 * <p>
...
public class FrameBodyTOPE extends AbstractFrameBodyTextInfo implements ID3v23FrameBody, ID3v24FrameBody {
	 ...
	 */
	public FrameBodyTOPE(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
