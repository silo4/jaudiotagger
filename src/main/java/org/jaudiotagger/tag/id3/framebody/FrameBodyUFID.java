...
/**
 * A UFID Framebody consists of an owner that identifies the server hosting the unique identifier database, and the
 * unique identifier itself which can be up to 64 bytes in length.
 */
public class FrameBodyUFID extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 *            unique identifier
	 */
	public FrameBodyUFID(final String owner, final byte[] uniqueIdentifier) {
		setOwner(owner);
	 ...
	 */
	public FrameBodyUFID(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	 ...
	 * @param uniqueIdentifier
	 */
	public void setUniqueIdentifier(final byte[] uniqueIdentifier) {
