 ...
 * <p>
 * The 'Size' frame contains the size of the audiofile in bytes, excluding the ID3v2 tag, represented as a numeric
 * string.
 * <p/>
 * <p>
...
public class FrameBodyTSIZ extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTSIZ(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
