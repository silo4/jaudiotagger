...
public class FrameBodyXSOT extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	...
	public FrameBodyXSOT(final FrameBodyXSOT body) {
		super(body);
	}
	 ...
	 * @param text
	 */
	public FrameBodyXSOT(final byte textEncoding, final String text) {
	 ...
	 */
	public FrameBodyXSOT(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
