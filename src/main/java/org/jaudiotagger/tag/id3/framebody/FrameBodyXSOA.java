...
public class FrameBodyXSOA extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	...
	public FrameBodyXSOA(final FrameBodyXSOA body) {
		super(body);
	}
	 ...
	 * @param text
	 */
	public FrameBodyXSOA(final byte textEncoding, final String text) {
	 ...
	 */
	public FrameBodyXSOA(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
