 ...
 * <p>
 * The 'Encoded by' frame contains the name of the person or organisation that encoded the audio file. This field may
 * contain a copyright message, if the audio file also is copyrighted by the encoder.
 * <p/>
 * <p>
...
public class FrameBodyTENC extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTENC(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
