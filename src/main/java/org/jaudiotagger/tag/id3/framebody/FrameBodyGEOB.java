 ...
 * <p/>
 * <p/>
 * In this frame any type of file can be encapsulated. After the header, 'Frame size' and 'Encoding' follows 'MIME type'
 * represented as as a terminated string encoded with ISO-8859-1. The filename is case sensitive and is encoded as
 * 'Encoding'. Then follows a content description as terminated string, encoded as 'Encoding'. The last thing in the
 * frame is the actual object. The first two strings may be omitted, leaving only their terminations. There may be more
 * than one "GEOB" frame in each tag, but only one with the same content descriptor.
 * </p>
 * <p>
 * <table border=0 width="70%">
 * <tr>
 * <td colspan=2>&lt;Header for 'General encapsulated object', ID: "GEOB"&gt;</td>
 * </tr>
 * <tr>
 * <td>Text encoding</td>
 * <td>$xx</td>
...
public class FrameBodyGEOB extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 * @param object
	 */
	public FrameBodyGEOB(final byte textEncoding, final String mimeType, final String filename, final String description, final byte[] object) {
	 ...
	 */
	public FrameBodyGEOB(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
