 ...
 * <p>
 * The 'Lyricist(s)/Text writer(s)' frame is intended for the writer(s) of the text or lyrics in the recording. They are
...
public class FrameBodyTEXT extends AbstractFrameBodyTextInfo implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyTEXT(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
