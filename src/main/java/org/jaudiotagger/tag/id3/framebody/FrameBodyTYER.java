 ...
 * <p>
 * The 'Year' frame is a numeric string with a year of the recording. This frames is always four characters long (until
 * the year 10000).
 * <p>
...
public class FrameBodyTYER extends AbstractFrameBodyTextInfo implements ID3v23FrameBody {
	 ...
	 * @param body
	 */
	public FrameBodyTYER(final FrameBodyTDRC body) {
	 ...
	 */
	public FrameBodyTYER(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
