 ...
 * frame header followed by encoding, language and content descriptors and is ended with the actual comment as a text
 * string. Newline characters are allowed in the comment text string. There may be more than one comment frame in each
 ...
 * <tr>
 * <td colspan=2>&lt;Header for 'Comment', ID: "COMM"&gt;</td>
 * </tr>
 * <tr>
 * <td>Text encoding</td>
 * <td width="80%">$xx</td>
 ...
 * </tr>
 * <tr>
 * <td>Short content descrip.</td>
 * <td>&lt;text string according to encoding&gt; $00 (00)</td>
 * </tr>
 * <tr>
 * <td>The actual text</td>
 * <td>&lt;full text string according to encoding&gt;</td>
 * </tr>
 * </table>
 * </p>
 * <p/>
...
public class FrameBodyCOMM extends AbstractID3v2FrameBody implements ID3v24FrameBody, ID3v23FrameBody {
	 ...
	 */
	public FrameBodyCOMM(final ByteBuffer byteBuffer, final int frameSize) throws InvalidTagException {
	...
	public void setLanguage(final String language) {
		...
		/*
		 * if(language==null) { throw new IllegalArgumentException(ErrorMessage.GENERAL_INVALID_NULL_ARGUMENT.getMsg());
		 * }
		 */
		setObjectValue(DataTypes.OBJ_LANGUAGE, language);
	}
	...
	/**
	 * Returns the the text field which holds the comment, adjusted to ensure does not return trailing null which is due
	 * to a iTunes bug.
	 * 
	...
	/**
	 * Because COMM have a text encoding we need to check the text String does not contain characters that cannot be
	 * encoded in current encoding before we write data. If there are we change the encoding.
	 */
	@Override
