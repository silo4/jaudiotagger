...
public class ID3Tags {
	 ...
	 */
	public static boolean isID3v22FrameIdentifier(final String identifier) {
	 ...
	 */
	public static boolean isID3v23FrameIdentifier(final String identifier) {
	 ...
	 */
	public static boolean isID3v24FrameIdentifier(final String identifier) {
		return identifier.length() >= 4 && ID3v24Frames.getInstanceOf().getIdToValueMap().containsKey(identifier.substring(0, 4));
	}

	/**
	 * Given an datatype, try to return it as a <code>long</code>. This tries to parse a string, and takes
	 * <code>Long, Short, Byte, Integer</code> objects and gets their value. An exception is not explicitly thrown here
	 * because it would causes too many other methods to also throw it.
	 * 
	 * @param value
	 *            datatype to find long from.
	 * @return <code>long</code> value
	 * @throws IllegalArgumentException
	 */
	static public long getWholeNumber(final Object value) {
		long number;
	 ...
	 * @return
	 */
	public static String convertFrameID22To23(final String identifier) {
		if (identifier.length() < 3)
			return null;
	 ...
	 * @return
	 */
	public static String convertFrameID22To24(final String identifier) {
		// Idv22 identifiers are only of length 3 times
		if (identifier.length() < 3)
			return null;
		// Has idv22 been mapped to v23
		final String id = ID3Frames.convertv22Tov23.get(identifier.substring(0, 3));
		if (id != null) {
			// has v2.3 been mapped to v2.4
			final String v23id = ID3Frames.convertv23Tov24.get(id);
			if (v23id == null) {
	 ...
	 * @return
	 */
	public static String convertFrameID23To22(final String identifier) {
	 ...
	 * @return
	 */
	public static String convertFrameID23To24(final String identifier) {
		if (identifier.length() < 4)
			return null;
	...
	/**
	 * Force from ID3v22 FrameIdentifier to ID3v23, this is where the frame and structure has changed from v2 to v3 but
	 * we can still do some kind of conversion.
	 * 
	 * @param identifier
	 * @return
	 */
	public static String forceFrameID22To23(final String identifier) {
	 ...
	 * @return
	 */
	public static String forceFrameID23To22(final String identifier) {
		return ID3Frames.forcev23Tov22.get(identifier);
	}

	/**
	 * Force from ID3v2.30 FrameIdentifier to ID3v2.40, this is where the frame and structure has changed from v3 to v4
	 * but we can still do some kind of conversion.
	 * 
	 * @param identifier
	 * @return
	 */
	public static String forceFrameID23To24(final String identifier) {
		return ID3Frames.forcev23Tov24.get(identifier);
	}

	/**
	 * Force from ID3v2.40 FrameIdentifier to ID3v2.30, this is where the frame and structure has changed between v4 to
	 * v3 but we can still do some kind of conversion.
	 * 
	 * @param identifier
	 * @return
	 */
	public static String forceFrameID24To23(final String identifier) {
	 ...
	 * @return
	 */
	public static String convertFrameID24To23(final String identifier) {
		String id;
		if (identifier.length() < 4)
			return null;
	...
	/**
	 * Unable to instantiate abstract classes, so can't call the copy constructor. So find out the instantiated class
	 * name and call the copy constructor through reflection (e.g for a a FrameBody would have to have a constructor
	 * that takes another frameBody as the same type as a parameter)
	 * 
	 * @param copyObject
	 * @return
	 * @throws IllegalArgumentException
	 *             if no suitable constructor exists
	 */
	 ...
	 */
	static public String stripChar(final String str, final char ch) {
		if (str != null) {
