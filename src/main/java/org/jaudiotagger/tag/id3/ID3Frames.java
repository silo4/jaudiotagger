...
public abstract class ID3Frames extends AbstractStringStringValuePair {
	 ...
	 * @return
	 */
	public boolean isDiscardIfFileAltered(final String frameID) {
	 ...
	 * @return
	 */
	public boolean isMultipleAllowed(final String frameID) {
	 ...
	 */
	public boolean isSupportedFrames(final String frameID) {
	 ...
	 */
	public boolean isCommon(final String frameID) {
	 ...
	 */
	public boolean isBinary(final String frameID) {
	 ...
	 */
	public boolean isExtensionFrames(final String frameID) {
	...
	private static void loadID3v23ID3v24Mapping() {
		...
		// This one way allows us to convert XSOT to TSOT,XSOP to TSOP and XSOA - TSOA but in the other direction gets
		// converted to TSOT,TSOP,TSOA
		...
		// No others exist because most v23 mappings are identical to v24 therefore no mapping required and the ones
		// that
