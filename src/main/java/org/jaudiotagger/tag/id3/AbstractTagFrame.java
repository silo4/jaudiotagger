...
public abstract class AbstractTagFrame extends AbstractTagItem {
	 ...
	 * @param copyObject
	 */
	public AbstractTagFrame(final AbstractTagFrame copyObject) {
	...
	/**
	 * Returns true if this datatype and it's body is a subset of the argument. This datatype is a subset if the
	...
	/**
	 * Returns true if this datatype and its body equals the argument and its body. this datatype is equal if and only
	 * if they are the same class and have the same <code>getSubId</code> id string.
	 * 
	 * @param obj
	 *            datatype to determine equality of
	 * @return true if this datatype and its body equals the argument and its body.
	 */
	@Override
	public boolean equals(final Object obj) {
		...
		final AbstractTagFrame that = (AbstractTagFrame) obj;
		return EqualsUtil.areEqual(this.getIdentifier(), that.getIdentifier()) && EqualsUtil.areEqual(this.frameBody, that.frameBody) && super.equals(that);
