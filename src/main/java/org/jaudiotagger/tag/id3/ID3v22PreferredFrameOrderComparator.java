...
public class ID3v22PreferredFrameOrderComparator implements Comparator<String> {
	...
	private static List<String> frameIdsInPreferredOrder = new ArrayList<String>();
	static {
		...
		// Itunes doesnt seem to like these, and of little use so put right at
		// end
	...
	public static ID3v22PreferredFrameOrderComparator getInstance() {
		if (comparator == null)
	 ...
	 */
	@Override
	public int compare(final String frameId1, final String frameId2) {
		final int frameId1Index = frameIdsInPreferredOrder.indexOf(frameId1);
		final int frameId2Index = frameIdsInPreferredOrder.indexOf(frameId2);
