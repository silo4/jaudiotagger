...
public abstract class AbstractTagFrameBody extends AbstractTagItem {
	...
	/**
	 * Reference to the header associated with this frame body, a framebody can be created without a header but one it
	 * is associated with a header this should be set. It is principally useful for the framebody to know its header,
	 * because this will specify its tag version and some framebodies behave slighly different between tag versions.
	 */
	...
	public final byte getTextEncoding() {
		final AbstractDataType o = getObject(DataTypes.OBJ_TEXT_ENCODING);

		if (o != null) {
			final Long encoding = (Long) (o.getValue());
	 ...
	 * 
	 * @param textEncoding
	 *            to use for this frame body
	 */
	public final void setTextEncoding(final byte textEncoding) {
		// Number HashMap actually converts this byte to a long
		setObjectValue(DataTypes.OBJ_TEXT_ENCODING, textEncoding);
	}

	/**
	 * Creates a new framebody, at this point the bodys ObjectList is setup which defines what datatypes are expected in
	 * body
	 */
	 ...
	 * @param copyObject
	 */
	protected AbstractTagFrameBody(final AbstractTagFrameBody copyObject) {
	...
	/**
	 * 
	 * @return the text value that the user would expect to see for this framebody type, this should be overridden for
	 *         all frame-bodies
	 */
	...
	public String getBriefDescription() {
		String str = "";
		for (final AbstractDataType object : objectList)
	 ...
	 * 
	 * @param identifier
	 *            <code>MP3Object</code> identifier
	 * @param value
	 *            new datatype value
	 */
	public final void setObjectValue(final String identifier, final Object value) {
		AbstractDataType object;
		final Iterator<AbstractDataType> iterator = objectList.listIterator();
	...
	/**
	 * Returns the value of the datatype with the specified <code>identifier</code>
	 * 
	 * @param identifier
	 * @return the value of the dattype with the specified <code>identifier</code>
	 */
	public final Object getObjectValue(final String identifier) {
		return getObject(identifier).getValue();
	}

	/**
	 * Returns the datatype with the specified <code>identifier</code>
	 * 
	 * @param identifier
	 * @return the datatype with the specified <code>identifier</code>
	 */
	public final AbstractDataType getObject(final String identifier) {
		AbstractDataType object;
		final Iterator<AbstractDataType> iterator = objectList.listIterator();
		while (iterator.hasNext()) {
			object = iterator.next();
	...
	/**
	 * Returns true if this instance and its entire DataType array list is a subset of the argument. This class is a
	 * subset if it is the same class as the argument.
	 * 
	 * @param obj
	...
	public boolean isSubsetOf(final Object obj) {
		if (!(obj instanceof AbstractTagFrameBody))
			return false;
		final ArrayList<AbstractDataType> superset = ((AbstractTagFrameBody) obj).objectList;
		for (final AbstractDataType anObjectList : objectList)
	...
	/**
	 * Returns true if this datatype and its entire DataType array list equals the argument. This datatype is equal to
	 * the argument if they are the same class.
	 * 
	 * @param obj
	...
	public boolean equals(final Object obj) {
		if (!(obj instanceof AbstractTagFrameBody))
			return false;
		final AbstractTagFrameBody object = (AbstractTagFrameBody) obj;
		final boolean check = this.objectList.equals(object.objectList) && super.equals(obj);
		return check;
	}
	...
	/**
	 * Create the list of Datatypes that this body expects in the correct order This method needs to be implemented by
	 * concrete subclasses
	 */
	 ...
	 * @param header
	 */
	public void setHeader(final AbstractTagFrame header) {
		this.header = header;
	}
}
