...
public class ID3v23Frames extends ID3Frames {
	...
	private ID3v23Frames() {
		...
		for (final Map.Entry<FieldKey, ID3v23FieldKey> next : tagFieldToId3.entrySet())
	 ...
	 */
	public ID3v23FieldKey getId3KeyFromGenericKey(final FieldKey genericKey) {
	 ...
	 * @return
	 */
	public FieldKey getGenericKeyFromId3(final ID3v23FieldKey fieldKey) {
