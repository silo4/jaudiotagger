...
public abstract class AbstractTag extends AbstractTagItem {
	...
	public AbstractTag(final AbstractTag copyObject) {
		super(copyObject);
	}
	...
	/**
	 * Determines whether another datatype is equal to this tag. It just compares if they are the same class, then calls
	 * <code>super.equals(obj)</code>.
	 * 
	 * @param obj
