...
/**
 * This class encapsulates the name and content of a tag entry in id3 fields <br>
 * 
...
public class ID3v1TagField implements TagTextField {
	...
	public ID3v1TagField(final byte[] raw) throws UnsupportedEncodingException {
		final String field = new String(raw, "ISO-8859-1");
	...
	private void checkCommon() {
		this.common = id.equals(ID3v1FieldKey.TITLE.name()) || id.equals(ID3v1FieldKey.ALBUM.name()) || id.equals(ID3v1FieldKey.ARTIST.name()) || id.equals(ID3v1FieldKey.GENRE.name()) || id.equals(ID3v1FieldKey.YEAR.name())
				|| id.equals(ID3v1FieldKey.COMMENT.name()) || id.equals(ID3v1FieldKey.TRACK.name());
	}
	...
	public byte[] getRawContent() throws UnsupportedEncodingException {
		...
		final byte[] idBytes = this.id.getBytes("ISO-8859-1");
		final byte[] contentBytes = Utils.getDefaultBytes(this.content, "ISO-8859-1");
