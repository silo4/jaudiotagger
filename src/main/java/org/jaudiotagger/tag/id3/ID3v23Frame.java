...
public class ID3v23Frame extends AbstractID3v2Frame {
	 ...
	 * create a new frame from scratch using user data.
	 * 
	 * @param identifier
	 */
	public ID3v23Frame(final String identifier) {
		super(identifier);
	 ...
	 * @param frame
	 */
	public ID3v23Frame(final ID3v23Frame frame) {
		super(frame);
	 ...
	 */
	public ID3v23Frame(final AbstractID3v2Frame frame) throws InvalidFrameException {
	 ...
	 * @throws org.jaudiotagger.tag.InvalidFrameException
	 */
	public ID3v23Frame(final ByteBuffer byteBuffer, final String loggingFilename) throws InvalidFrameException, InvalidDataTypeException {
	 ...
	 */
	@Deprecated
	public ID3v23Frame(final ByteBuffer byteBuffer) throws InvalidFrameException, InvalidDataTypeException {
		this(byteBuffer, "");
	}
	...
	public boolean equals(final Object obj) {
		...
		if (!(obj instanceof ID3v23Frame))
			return false;
		final ID3v23Frame that = (ID3v23Frame) obj;
	...
	public void write(final ByteArrayOutputStream tagBuffer) {
		...
		// Write Frame Size
		final int size = frameBody.getSize();
	...
	class StatusFlags extends AbstractID3v2Frame.StatusFlags {
		 ...
		 * @param statusFlags
		 */
		StatusFlags(final ID3v24Frame.StatusFlags statusFlags) {
			originalFlags = convertV4ToV3Flags(statusFlags.getOriginalFlags());
			writeFlags = originalFlags;
			modifyFlags();
		}

		private byte convertV4ToV3Flags(final byte v4Flag) {
			byte v3Flag = (byte) 0;
	...
	class EncodingFlags extends AbstractID3v2Frame.EncodingFlags {
		...
		public EncodingFlags(final byte flags) {
			super(flags);
			logEnabledFlags();
		}
		...
		public boolean isNonStandardFlags() {
			return ((flags & FileConstants.BIT4) > 0) || ((flags & FileConstants.BIT3) > 0) || ((flags & FileConstants.BIT2) > 0) || ((flags & FileConstants.BIT1) > 0) || ((flags & FileConstants.BIT0) > 0);
	...
	public boolean isValidID3v2FrameIdentifier(final String identifier) {
		final Matcher m = ID3v23Frame.validFrameIdentifier.matcher(identifier);
		return m.matches();
	}
