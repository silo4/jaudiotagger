...
/**
 * This specifies a series of methods that have to be implemented by all structural subclasses, required to support all
 * copy constructors,iterative methods and so on.
 * <p/>
...
public abstract class AbstractTagItem {
	...
	public AbstractTagItem(final AbstractTagItem copyObject) {
	...
	/**
	 * Returns true if this datatype is a subset of the argument. This instance is a subset if it is the same class as
	 * the argument.
	 * 
	 * @param obj
