...
public class ID3v22Frames extends ID3Frames {
	...
	private ID3v22Frames() {
		...
		for (final Map.Entry<FieldKey, ID3v22FieldKey> next : tagFieldToId3.entrySet())
	 ...
	 */
	public ID3v22FieldKey getId3KeyFromGenericKey(final FieldKey genericKey) {
	 ...
	 * @return
	 */
	public FieldKey getGenericKeyFromId3(final ID3v22FieldKey fieldKey) {
