...
public class ID3v24Frames extends ID3Frames {
	...
	private ID3v24Frames() {
		...
		for (final Map.Entry<FieldKey, ID3v24FieldKey> next : tagFieldToId3.entrySet())
	 ...
	 */
	public ID3v24FieldKey getId3KeyFromGenericKey(final FieldKey genericKey) {
	 ...
	 * @return
	 */
	public FieldKey getGenericKeyFromId3(final ID3v24FieldKey fieldKey) {
