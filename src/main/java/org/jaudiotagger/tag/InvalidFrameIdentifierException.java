...
public class InvalidFrameIdentifierException extends InvalidFrameException {
	 ...
	 *            the cause.
	 */
	public InvalidFrameIdentifierException(final Throwable ex) {
		super(ex);
	}
	 ...
	 *            the detail message.
	 */
	public InvalidFrameIdentifierException(final String msg) {
		super(msg);
	}
	 ...
	 *            the cause.
	 */
	public InvalidFrameIdentifierException(final String msg, final Throwable ex) {
		super(msg, ex);
	}
