...
/**
 * This interface represents the basic data structure for the default audio library functionality.<br>
 * <p/>
 * Some audio file tagging systems allow to specify multiple values for one type of information. The artist for example.
 * Some songs may be a cooperation of two or more artists. Sometimes a tagging user wants to specify them in the tag
 * without making one long text string.<br>
 * 
 * The addField() method can be used for this but it is possible the underlying implementation does not support that
 * kind of storing multiple values and will just overwrite the existing value<br>
 * <br>
...
public interface Tag {
	...
	/**
	 * Returns <code>true</code>, if at least one of the contained {@linkplain TagField fields} is a common field (
