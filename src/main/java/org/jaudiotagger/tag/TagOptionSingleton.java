...
public class TagOptionSingleton {
	...
	/**
	 * Map of lyric ID's to Boolean objects if we should or should not save the specific lyrics3 field. Defaults to
	 * true.
	 */
	...
	/**
	 * default language for any ID3v2 tags frames which require it. This string is in the [ISO-639-2] ISO/FDIS 639-2
	 * definition
	 */
	...
	/**
	 * iTunes needlessly writes null terminators at the end for TextEncodedStringSizeTerminated values, if this option
	 * is enabled these characters are removed
	 */
	private boolean removeTrailingTerminatorOnWrite = true;

	/**
	 * This is the default text encoding to use for new v23 frames, when unicode is required UTF16 will always be used
	 * because that is the only valid option for v23.
	 */
	private byte id3v23DefaultTextEncoding = TextEncoding.ISO_8859_1;

	/**
	 * This is the default text encoding to use for new v24 frames, it defaults to simple ISO8859 but by changing this
	 * value you could always used UTF8 for example whether you needed to or not
	 */
	private byte id3v24DefaultTextEncoding = TextEncoding.ISO_8859_1;

	/**
	 * This is text encoding to use for new v24 frames when unicode is required, it defaults to UTF16 just because this
	 * encoding is understand by all ID3 versions
	 */
	private byte id3v24UnicodeTextEncoding = TextEncoding.UTF_16;

	/**
	 * When writing frames if this is set to true then the frame will be written using the defaults disregarding the
	 * text encoding originally used to create the frame.
	 */
	private boolean resetTextEncodingForExistingFrames = false;

	/**
	 * Some formats impose maxmimum lengths for fields , if the text provided is longer than the formats allows it will
	 * truncate and write a warning, if this is not set it will throw an exception
	 */
	...
	/**
	 * There are a couple of problems with the Java implementation on Google Android, enabling this value switches on
	 * Google workarounds
	 */
	private boolean isAndroid = false;

	/**
	 * When you specify a field should be stored as UTF16 in ID3 this means write with BOM indicating whether written as
	 * Little Endian or Big Endian, its defaults to little Endian
	 */
	private boolean isEncodeUTF16BomAsLittleEndian = true;

	/**
	 * When this is set and using the generic interface jaudiotagger will make some adjustments when saving field so
	 * they work best with the specified Tagger
	 */
	 ...
	 * @return
	 */
	public static TagOptionSingleton getInstance(final String instanceKey) {
	 ...
	 * @param id3v2Version
	 */
	public void setID3V2Version(final ID3V2Version id3v2Version) {
	 ...
	 * @return
	 */
	public Iterator<String> getKeywordListIterator(final Class<? extends ID3v24FrameBody> id3v2_4FrameBody) {
	 ...
	 *            Lyrics3 id string
	 * @param save
	 *            true if you want to save this specific Lyrics3 field.
	 */
	 ...
	 * 
	 * @param tsf
	 *            the new default time stamp format
	 */
	 ...
	 * @throws TagException
	 */
	public void addKeyword(final Class<? extends ID3v24FrameBody> id3v2FrameBodyClass, final String keyword) throws TagException {
	 ...
	 * 
	 * @param unsyncTags
	 *            set whether tags are unsynchronized when written if contain bit pattern that could be mistaken for
	 *            audio marker
	 */
	public void setUnsyncTags(final boolean unsyncTags) {
	 ...
	 * 
	 */
	public void setRemoveTrailingTerminatorOnWrite(final boolean removeTrailingTerminatorOnWrite) {
		this.removeTrailingTerminatorOnWrite = removeTrailingTerminatorOnWrite;
	}

	/**
	 * Get the default text encoding to use for new v23 frames, when unicode is required UTF16 will always be used
	 * because that is the only valid option for v23/v22
	 * 
	 * @return
	 */
	...
	/**
	 * Set the default text encoding to use for new v23 frames, when unicode is required UTF16 will always be used
	 * because that is the only valid option for v23/v22
	 * 
	 * @param id3v23DefaultTextEncoding
	 */
	public void setId3v23DefaultTextEncoding(final byte id3v23DefaultTextEncoding) {
	...
	/**
	 * Get the default text encoding to use for new v24 frames, it defaults to simple ISO8859 but by changing this value
	 * you could always used UTF8 for example whether you needed to or not
	 * 
	 * @return
	 */
	...
	/**
	 * Set the default text encoding to use for new v24 frames, it defaults to simple ISO8859 but by changing this value
	 * you could always used UTF8 for example whether you needed to or not
	 * 
	 * @param id3v24DefaultTextEncoding
	 */
	public void setId3v24DefaultTextEncoding(final byte id3v24DefaultTextEncoding) {
	...
	/**
	 * Get the text encoding to use for new v24 frames when unicode is required, it defaults to UTF16 just because this
	 * encoding is understand by all ID3 versions
	 * 
	 * @return
	 */
	...
	/**
	 * Set the text encoding to use for new v24 frames when unicode is required, it defaults to UTF16 just because this
	 * encoding is understand by all ID3 versions
	 * 
	 * @param id3v24UnicodeTextEncoding
	 */
	public void setId3v24UnicodeTextEncoding(final byte id3v24UnicodeTextEncoding) {
	 ...
	 * 
	 */
	public void setResetTextEncodingForExistingFrames(final boolean resetTextEncodingForExistingFrames) {
	 ...
	 */
	public void setTruncateTextWithoutErrors(final boolean truncateTextWithoutErrors) {
	...
	public void setPadNumbers(final boolean padNumbers) {
	...
	public void setAndroid(final boolean android) {
		isAndroid = android;
	}

	/**
	 * When this is set and using the generic interface jaudiotagger will make some adjustmensts when saving field sso
	 * they work best with the specified Tagger
	 * 
	 */
	...
	public void setPlayerCompatability(final int playerCompatability) {
	...
	public void setEncodeUTF16BomAsLittleEndian(final boolean encodeUTF16BomAsLittleEndian) {
		isEncodeUTF16BomAsLittleEndian = encodeUTF16BomAsLittleEndian;
	}

	/**
	 * When we have to create new audio files and shift audio data to fit in more metadata this value set the maximum
	 * amount in bytes that can be transferred in one call, this is to protect against various OutOfMemoryExceptions
	 * that cna occur, especially on networked filesystems.
	 */
	public long getWriteChunkSize() {
		return writeChunkSize;
	}

	public void setWriteChunkSize(final long writeChunkSize) {
		this.writeChunkSize = writeChunkSize;
	}

	/**
	 * If enabled we always use the ©gen atom rather than the gnre atom when writing genres to mp4s This is known to
	 * help some android apps
	 */
	public boolean isWriteMp4GenresAsText() {
		return isWriteMp4GenresAsText;
	}

	public void setWriteMp4GenresAsText(final boolean writeMp4GenresAsText) {
	...
	public void setPadNumberTotalLength(final PadNumberOption padNumberTotalLength) {
