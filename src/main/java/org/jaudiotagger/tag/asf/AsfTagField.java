...
/**
 * This class encapsulates a {@link org.jaudiotagger.audio.asf.data.MetadataDescriptor}and provides access to it. <br>
...
public class AsfTagField implements TagField, Cloneable {
	...
	public AsfTagField(final AsfFieldKey field) {
		assert field != null;
		this.toWrap = new MetadataDescriptor(field.getHighestContainer(), field.getFieldName(), MetadataDescriptor.TYPE_STRING);
	}
	 ...
	 * 
	 * @param source
	 *            The descriptor which should be represented as a {@link TagField}.
	 */
	...
	public AsfTagField(final String fieldKey) {
		...
		this.toWrap = new MetadataDescriptor(AsfFieldKey.getAsfFieldKey(fieldKey).getHighestContainer(), fieldKey, MetadataDescriptor.TYPE_STRING);
	}
