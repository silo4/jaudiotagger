...
/**
 * This field represents the image content of the banner image which is stored in the {@linkplain ContentBranding
 * content branding} chunk of ASF files.<br>
 * 
...
public class AsfTagBannerField extends AbstractAsfTagImageField {
	...
	public AsfTagBannerField(final MetadataDescriptor descriptor) {
		super(descriptor);
		assert descriptor.getName().equals(AsfFieldKey.BANNER_IMAGE.getFieldName());
	}
	...
	public AsfTagBannerField(final byte[] imageData) {
		super(new MetadataDescriptor(ContainerType.CONTENT_BRANDING, AsfFieldKey.BANNER_IMAGE.getFieldName(), MetadataDescriptor.TYPE_BINARY));
