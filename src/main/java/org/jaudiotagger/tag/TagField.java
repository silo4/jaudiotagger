...
public interface TagField {
	 ...
	 * 
	 * @param b
	 *            <code>true</code>, if the field contains binary data. //@deprecated As for now is of no use.
	 *            Implementations should use another // way of setting this property.
	 */
	 ...
	 * For text fields it should be the text itself. Other fields containing images may return a formatted string with
	 * image properties like width, height and so on.
	 * 
