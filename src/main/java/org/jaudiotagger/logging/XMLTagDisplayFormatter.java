...
public class XMLTagDisplayFormatter extends AbstractTagDisplayFormatter {
	 ...
	 * @return
	 */
	public static String xmlOpen(final String xmlName) {
		return xmlOpenStart + xmlName + xmlOpenEnd;
	}

	public static String xmlOpenHeading(final String name, final String data) {
		return (xmlOpen(name + " id=\"" + data + "\""));
	}

	/**
	 * Return CDATA tag around xml data e.g <![CDATA[xmlData]]> We also need to deal with special chars
	 * 
	 * @param xmlData
	 * @return
	 */
	public static String xmlCData(final String xmlData) {
		char tempChar;
		final StringBuffer replacedString = new StringBuffer();
	 ...
	 * @return
	 */
	public static String xmlClose(final String xmlName) {
		return xmlCloseStart + xmlName + xmlCloseEnd;
	}

	public static String xmlSingleTag(final String data) {
		return xmlOpenStart + data + xmlSingleTagClose;
	}

	public static String xmlFullTag(final String xmlName, final String data) {
	...
	/**
	 * Replace any special xml characters with the appropiate escape sequences required to be done for the actual
	 * element names
	 * 
	 * @param xmlData
	 * @return
	 */
	public static String replaceXMLCharacters(final String xmlData) {
		final StringBuffer sb = new StringBuffer();
		final StringCharacterIterator sCI = new StringCharacterIterator(xmlData);
